...
function Fl(n) {
  return n === null ? null : `#${Gc(n).toString(16).padStart(6, "0")}`;
}
function kl(n) {
  if (!n)
    return null;
...
function Al(n) {
  ...
  const e = kl(t);
  if (e)
    return Gc(Number.parseInt(e.slice(1), 16));
...
class Ol {
  ...
  constructor(t, e, s = {}) {
    ...
    const i = e ?? new ys();
    this.ctxStack = new Ml(i), this.yieldPropertyCommands = s.yieldPropertyCommands ?? !1, this.resetParagraphParameters = s.resetParagraphParameters ?? !1, this.yieldPercentSymbols = s.yieldPercentSymbols ?? !1, this.mifDecoder = s.mifDecoder ?? this.decodeMultiByteChar.bind(this), this.mifCodeLength = s.mifCodeLength ?? "auto";
  }
  /**
  ...
  parseStacking() {
    ...
    return [e, i] = a(), i && (s = o(i === "^")), e === "" && s.includes("I/") ? [nt.STACK, [" ", " ", "/"]] : i === "^" ? [nt.STACK, [e, s, "^"]] : [nt.STACK, [e, s, i]];
  }
  /**
  ...
  *parse() {
    ...
    function r(o) {
      ...
      const h = {};
      return c.indent !== 0 && (h.indent = 0), c.left !== 0 && (h.left = 0), c.right !== 0 && (h.right = 0), c.align !== ot.DEFAULT && (h.align = ot.DEFAULT), JSON.stringify(c.tabs) !== JSON.stringify([]) && (h.tabs = []), h;
    }
    const a = () => {
      let o = "";
      for (; this.scanner.hasData; ) {
        ...
        if (h.charCodeAt(0) < 32) {
          if (this.scanner.consume(1), h === "	")
            return [nt.TABULATOR, null];
          if (h === `
`)
            return [nt.NEW_PARAGRAPH, null];
          h = " ";
        }
        if (h === "\\")
          if ("\\{}".includes(this.scanner.peek(1)))
            ...
            switch (u) {
              ...
              case "P":
                return [nt.NEW_PARAGRAPH, null];
              case "N":
                return [nt.NEW_COLUMN, null];
              case "X":
                return [nt.WRAP_AT_DIMLINE, null];
              case "S": {
                ...
                if (u)
                  try {
                    ...
                    if (this.yieldPropertyCommands && f)
                      return [nt.PROPERTIES_CHANGED, f];
                    continue;
                  } catch {
        ...
        if (h === "%" && this.scanner.peek(1) === "%") {
          const u = this.scanner.peek(2).toLowerCase(), f = wl[u];
          if (f) {
            if (this.scanner.consume(3), this.yieldPercentSymbols) {
              const p = this.buildPercentSymbolData(u, f);
              if (p)
                return o ? (s = nt.PERCENT_SYMBOL, i = p, [t, o]) : [nt.PERCENT_SYMBOL, p];
            }
            o += f;
            continue;
          } else {
            ...
            if (p.every((d) => d >= "0" && d <= "9")) {
              ...
              if (this.scanner.consume(5), this.yieldPercentSymbols) {
                ...
                return o ? (s = nt.PERCENT_SYMBOL, i = g, [t, o]) : [nt.PERCENT_SYMBOL, g];
              }
        ...
        if (!this.inStackContext && h === "^") {
          ...
          if (u) {
            ...
            if (this.scanner.consume(2), f === 32)
              ...
              if (f === 73)
                return o ? [t, o] : [nt.TABULATOR, null];
              if (f === 74)
                return o ? [t, o] : [nt.NEW_PARAGRAPH, null];
              if (f === 77)
                continue;
              o += "▯";
            }
      ...
      return o ? [t, o] : [nt.NONE, null];
    };
    for (; ; ) {
      const [o, c] = a.call(this);
      if (o) {
        if (yield new Ni(o, this.ctxStack.current.copy(), c), o === nt.NEW_PARAGRAPH && this.resetParagraphParameters) {
          const h = this.ctxStack.current, l = r(h);
          this.yieldPropertyCommands && Object.keys(l).length > 0 && (yield new Ni(nt.PROPERTIES_CHANGED, h.copy(), {
            command: void 0,
            changes: { paragraph: l },
            depth: this.ctxStack.depth
          }));
        }
        s && (yield new Ni(s, this.ctxStack.current.copy(), i ?? null), s = null, i = void 0);
      } else
        break;
    }
  }
...
class Xe {
   ...
   */
  toCssColor() {
    return this._rgbValue !== null ? Fl(this._rgbValue) : null;
  }
  /**
...
class ys {
  constructor() {
    this._stroke = 0, this.continueStroke = !1, this.color = new Xe(), this.align = je.BOTTOM, this.fontFace = { family: "", style: "Regular", weight: 400 }, this._capHeight = { value: 1, isRelative: !1 }, this._widthFactor = { value: 1, isRelative: !1 }, this._charTrackingFactor = { value: 1, isRelative: !1 }, this.oblique = 0, this.paragraph = {
      indent: 0,
      left: 0,
      right: 0,
      align: ot.DEFAULT,
 ...
 */
const Vc = "172", Ur = 0, _l = 1, _a = 1, La = 100, Ia = 204, Ra = 205, Ba = 3, Ll = 0, Wc = 300, Da = 1e3, As = 1001, Ua = 1002, Il = 1006, Rl = 1008, Bl = 1009, Dl = 1015, Ul = 1023, qc = "", re = "srgb", Pa = "srgb-linear", za = "linear", Hi = "srgb", bn = 7680, Na = 519, Ha = 35044, Es = 2e3, Ga = 2001;
class _i {
...
function qn() {
  ...
  return (Mt[n & 255] + Mt[n >> 8 & 255] + Mt[n >> 16 & 255] + Mt[n >> 24 & 255] + "-" + Mt[t & 255] + Mt[t >> 8 & 255] + "-" + Mt[t >> 16 & 15 | 64] + Mt[t >> 24 & 255] + "-" + Mt[e & 63 | 128] + Mt[e >> 8 & 255] + "-" + Mt[e >> 16 & 255] + Mt[e >> 24 & 255] + Mt[s & 255] + Mt[s >> 8 & 255] + Mt[s >> 16 & 255] + Mt[s >> 24 & 255]).toLowerCase();
}
function Z(n, t, e) {
...
function Nl() {
  const n = {
    ...
    convert: function(i, r, a) {
      return this.enabled === !1 || r === a || !r || !a || (this.spaces[r].transfer === Hi && (i.r = Ie(i.r), i.g = Ie(i.g), i.b = Ie(i.b)), this.spaces[r].primaries !== this.spaces[a].primaries && (i.applyMatrix3(this.spaces[r].toXYZ), i.applyMatrix3(this.spaces[a].fromXYZ)), this.spaces[a].transfer === Hi && (i.r = Bn(i.r), i.g = Bn(i.g), i.b = Bn(i.b))), i;
    },
    ...
    getTransfer: function(i) {
      return i === qc ? za : this.spaces[i].transfer;
    },
...
class Hl {
  static getDataURL(t) {
    ...
    if (t instanceof HTMLCanvasElement)
      ...
      vn === void 0 && (vn = Va("canvas")), vn.width = t.width, vn.height = t.height;
      const s = vn.getContext("2d");
      t instanceof ImageData ? s.putImageData(t, 0, 0) : s.drawImage(t, 0, 0, t.width, t.height), e = vn;
    }
  ...
  static sRGBToLinear(t) {
    if (typeof HTMLImageElement < "u" && t instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && t instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && t instanceof ImageBitmap) {
      ...
      for (let s = 0; s < e.length; s++)
        e instanceof Uint8Array || e instanceof Uint8ClampedArray ? e[s] = Math.floor(Ie(e[s] / 255) * 255) : e[s] = Ie(e[s]);
      return {
        data: e,
        width: t.width,
        height: t.height
...
class Vl {
  constructor(t = null) {
    this.isSource = !0, Object.defineProperty(this, "id", { value: Gl++ }), this.uuid = qn(), this.data = t, this.dataReady = !0, this.version = 0;
  }
  set needsUpdate(t) {
    t === !0 && this.version++;
  }
...
function Wi(n) {
  return typeof HTMLImageElement < "u" && n instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && n instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && n instanceof ImageBitmap ? Hl.getDataURL(n) : n.data ? {
...
ln.DEFAULT_MAPPING = Wc;
ln.DEFAULT_ANISOTROPY = 1;
class xs {
  constructor(t = 0, e = 0, s = 0, i = 1) {
    xs.prototype.isVector4 = !0, this.x = t, this.y = e, this.z = s, this.w = i;
  }
  get width() {
    return this.z;
  }
...
const qi = /* @__PURE__ */ new E(), ja = /* @__PURE__ */ new gn();
class _t {
  ...
  expandByObject(t, e = !1) {
    ...
    if (s !== void 0) {
      ...
      if (e === !0 && r !== void 0 && t.isInstancedMesh !== !0)
        ...
        t.boundingBox !== void 0 ? (t.boundingBox === null && t.computeBoundingBox(), Ms.copy(t.boundingBox)) : (s.boundingBox === null && s.computeBoundingBox(), Ms.copy(s.boundingBox)), Ms.applyMatrix4(t.matrixWorld), this.union(Ms);
    }
    const i = t.children;
    for (let r = 0, a = i.length; r < a; r++)
  ...
  intersectsTriangle(t) {
    if (this.isEmpty())
      return !1;
    this.getCenter(Yn), Os.subVectors(this.max, Yn), Sn.subVectors(t.a, Yn), wn.subVectors(t.b, Yn), Cn.subVectors(t.c, Yn), Be.subVectors(wn, Sn), De.subVectors(Cn, wn), en.subVectors(Sn, Cn);
    let e = [
      0,
      -Be.z,
      Be.y,
    ...
    return !ji(e, Sn, wn, Cn, Os) || (e = [1, 0, 0, 0, 1, 0, 0, 0, 1], !ji(e, Sn, wn, Cn, Os)) ? !1 : (_s.crossVectors(Be, De), e = [_s.x, _s.y, _s.z], ji(e, Sn, wn, Cn, Os));
  }
  clampPoint(t, e) {
  ...
  applyMatrix4(t) {
    return this.isEmpty() ? this : (Ce[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(t), Ce[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(t), Ce[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(t), Ce[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(t), Ce[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(t), Ce[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(t), Ce[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(t), Ce[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(t), this.setFromPoints(Ce), this);
  }
  translate(t) {
...
const Ce = [
  ...
  /* @__PURE__ */ new E(),
  /* @__PURE__ */ new E()
], ne = /* @__PURE__ */ new E(), Ms = /* @__PURE__ */ new _t(), Sn = /* @__PURE__ */ new E(), wn = /* @__PURE__ */ new E(), Cn = /* @__PURE__ */ new E(), Be = /* @__PURE__ */ new E(), De = /* @__PURE__ */ new E(), en = /* @__PURE__ */ new E(), Yn = /* @__PURE__ */ new E(), Os = /* @__PURE__ */ new E(), _s = /* @__PURE__ */ new E(), nn = /* @__PURE__ */ new E();
...
const ql = /* @__PURE__ */ new _t(), Zn = /* @__PURE__ */ new E(), $i = /* @__PURE__ */ new E();
class ra {
  ...
  setFromPoints(t, e) {
    const s = this.center;
    e !== void 0 ? s.copy(e) : ql.setFromPoints(t).getCenter(s);
    let i = 0;
  ...
  expandByPoint(t) {
    ...
    if (e > this.radius * this.radius) {
      ...
      this.center.addScaledVector(Zn, i / s), this.radius += i;
    }
    return this;
  }
  union(t) {
    return t.isEmpty() ? this : this.isEmpty() ? (this.copy(t), this) : (this.center.equals(t.center) === !0 ? this.radius = Math.max(this.radius, t.radius) : ($i.subVectors(t.center, this.center).setLength(t.radius), this.expandByPoint(Zn.copy(t.center).add($i)), this.expandByPoint(Zn.copy(t.center).sub($i))), this);
  }
  equals(t) {
...
const Te = /* @__PURE__ */ new E(), Xi = /* @__PURE__ */ new E(), Ls = /* @__PURE__ */ new E(), Ue = /* @__PURE__ */ new E(), Yi = /* @__PURE__ */ new E(), Is = /* @__PURE__ */ new E(), Zi = /* @__PURE__ */ new E();
class jc {
  ...
  distanceSqToSegment(t, e, s, i) {
    Xi.copy(t).add(e).multiplyScalar(0.5), Ls.copy(e).sub(t).normalize(), Ue.copy(this.origin).sub(Xi);
    const r = t.distanceTo(e) * 0.5, a = -this.direction.dot(Ls), o = Ue.dot(this.direction), c = -Ue.dot(Ls), h = Ue.lengthSq(), l = Math.abs(1 - a * a);
    let u, f, p, d;
    if (l > 0)
    ...
    return s && s.copy(this.origin).addScaledVector(this.direction, u), i && i.copy(Xi).addScaledVector(Ls, f), p;
  }
  intersectSphere(t, e) {
    Te.subVectors(t.center, this.origin);
    const s = Te.dot(this.direction), i = Te.dot(Te) - s * s, r = t.radius * t.radius;
    if (i > r) return null;
  ...
  intersectTriangle(t, e, s, i, r) {
    Yi.subVectors(e, t), Is.subVectors(s, t), Zi.crossVectors(Yi, Is);
    ...
    if (a > 0) {
      ...
      return null;
    Ue.subVectors(this.origin, t);
    const c = o * this.direction.dot(Is.crossVectors(Ue, Is));
    if (c < 0)
      return null;
    const h = o * this.direction.dot(Yi.cross(Ue));
    if (h < 0 || c + h > a)
      return null;
    const l = -o * Ue.dot(Zi);
...
class Tt {
  ...
  extractRotation(t) {
    const e = this.elements, s = t.elements, i = 1 / Tn.setFromMatrixColumn(t, 0).length(), r = 1 / Tn.setFromMatrixColumn(t, 1).length(), a = 1 / Tn.setFromMatrixColumn(t, 2).length();
  ...
  makeRotationFromQuaternion(t) {
    return this.compose(jl, t, $l);
  }
  lookAt(t, e, s) {
    const i = this.elements;
    return Vt.subVectors(t, e), Vt.lengthSq() === 0 && (Vt.z = 1), Vt.normalize(), Pe.crossVectors(s, Vt), Pe.lengthSq() === 0 && (Math.abs(s.z) === 1 ? Vt.x += 1e-4 : Vt.z += 1e-4, Vt.normalize(), Pe.crossVectors(s, Vt)), Pe.normalize(), Rs.crossVectors(Vt, Pe), i[0] = Pe.x, i[4] = Rs.x, i[8] = Vt.x, i[1] = Pe.y, i[5] = Rs.y, i[9] = Vt.y, i[2] = Pe.z, i[6] = Rs.z, i[10] = Vt.z, this;
  }
  multiply(t) {
    return this.multiplyMatrices(this, t);
  }
  ...
  decompose(t, e, s) {
    ...
    const a = Tn.set(i[4], i[5], i[6]).length(), o = Tn.set(i[8], i[9], i[10]).length();
  ...
  makePerspective(t, e, s, i, r, a, o = Es) {
  ...
  makeOrthographic(t, e, s, i, r, a, o = Es) {
...
const Tn = /* @__PURE__ */ new E(), se = /* @__PURE__ */ new Tt(), jl = /* @__PURE__ */ new E(0, 0, 0), $l = /* @__PURE__ */ new E(1, 1, 1), Pe = /* @__PURE__ */ new E(), Rs = /* @__PURE__ */ new E(), Vt = /* @__PURE__ */ new E(), $a = /* @__PURE__ */ new Tt(), Xa = /* @__PURE__ */ new gn();
class bs {
  constructor(t = 0, e = 0, s = 0, i = bs.DEFAULT_ORDER) {
...
let Yl = 0;
const Ya = /* @__PURE__ */ new E(), Fn = /* @__PURE__ */ new gn(), Fe = /* @__PURE__ */ new Tt(), Bs = /* @__PURE__ */ new E(), Jn = /* @__PURE__ */ new E(), Zl = /* @__PURE__ */ new E(), Jl = /* @__PURE__ */ new gn(), Za = /* @__PURE__ */ new E(1, 0, 0), Ja = /* @__PURE__ */ new E(0, 1, 0), Ka = /* @__PURE__ */ new E(0, 0, 1), Qa = { type: "added" }, Kl = { type: "removed" }, kn = { type: "childadded", child: null }, Ji = { type: "childremoved", child: null };
class jt extends _i {
  constructor() {
    super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: Yl++ }), this.uuid = qn(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = jt.DEFAULT_UP.clone();
    const t = new E(), e = new bs(), s = new gn(), i = new E(1, 1, 1);
    function r() {
      s.setFromEuler(e, !1);
    }
    function a() {
  ...
  worldToLocal(t) {
    return this.updateWorldMatrix(!0, !1), t.applyMatrix4(Fe.copy(this.matrixWorld).invert());
  }
  lookAt(t, e, s) {
    t.isVector3 ? Bs.copy(t) : Bs.set(t, e, s);
    const i = this.parent;
    this.updateWorldMatrix(!0, !1), Jn.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? Fe.lookAt(Jn, Bs, this.up) : Fe.lookAt(Bs, Jn, this.up), this.quaternion.setFromRotationMatrix(Fe), i && (Fe.extractRotation(i.matrixWorld), Fn.setFromRotationMatrix(Fe), this.quaternion.premultiply(Fn.invert()));
  }
  add(t) {
    ...
    return t === this ? (console.error("THREE.Object3D.add: object can't be added as a child of itself.", t), this) : (t && t.isObject3D ? (t.removeFromParent(), t.parent = this, this.children.push(t), t.dispatchEvent(Qa), kn.child = t, this.dispatchEvent(kn), kn.child = null) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", t), this);
  }
  remove(t) {
    if (arguments.length > 1) {
    ...
    return e !== -1 && (t.parent = null, this.children.splice(e, 1), t.dispatchEvent(Kl), Ji.child = t, this.dispatchEvent(Ji), Ji.child = null), this;
  }
  removeFromParent() {
    const t = this.parent;
  ...
  attach(t) {
    return this.updateWorldMatrix(!0, !1), Fe.copy(this.matrixWorld).invert(), t.parent !== null && (t.parent.updateWorldMatrix(!0, !1), Fe.multiply(t.parent.matrixWorld)), t.applyMatrix4(Fe), t.removeFromParent(), t.parent = this, this.children.push(t), t.updateWorldMatrix(!1, !0), t.dispatchEvent(Qa), kn.child = t, this.dispatchEvent(kn), kn.child = null, this;
  }
  getObjectById(t) {
  ...
  getWorldQuaternion(t) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Jn, t, Zl), t;
  }
  getWorldScale(t) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Jn, Jl, t), t;
  }
  getWorldDirection(t) {
...
const ie = /* @__PURE__ */ new E(), ke = /* @__PURE__ */ new E(), Ki = /* @__PURE__ */ new E(), Ae = /* @__PURE__ */ new E(), An = /* @__PURE__ */ new E(), En = /* @__PURE__ */ new E(), to = /* @__PURE__ */ new E(), Qi = /* @__PURE__ */ new E(), tr = /* @__PURE__ */ new E(), er = /* @__PURE__ */ new E(), nr = /* @__PURE__ */ new xs(), sr = /* @__PURE__ */ new xs(), ir = /* @__PURE__ */ new xs();
class ce {
  ...
  closestPointToPoint(t, e) {
    ...
    let a, o;
    An.subVectors(i, s), En.subVectors(r, s), Qi.subVectors(t, s);
    const c = An.dot(Qi), h = En.dot(Qi);
    if (c <= 0 && h <= 0)
      return e.copy(s);
    tr.subVectors(t, i);
    const l = An.dot(tr), u = En.dot(tr);
    if (l >= 0 && u <= l)
      return e.copy(i);
    const f = c * u - l * h;
    if (f <= 0 && c >= 0 && l <= 0)
    ...
    er.subVectors(t, r);
    const p = An.dot(er), d = En.dot(er);
    if (d >= 0 && p <= d)
      return e.copy(r);
    const g = p * h - c * d;
    if (g <= 0 && h >= 0 && d <= 0)
      return o = h / (h - d), e.copy(s).addScaledVector(En, o);
    const x = l * d - p * u;
    if (x <= 0 && u - l >= 0 && p - d >= 0)
      return to.subVectors(r, i), o = (u - l) / (u - l + (p - d)), e.copy(i).addScaledVector(to, o);
    const b = 1 / (x + g + f);
    return a = g * b, o = f * b, e.copy(s).addScaledVector(An, a).addScaledVector(En, o);
  }
  equals(t) {
...
class jn {
  ...
  setHSL(t, e, s, i = ee.workingColorSpace) {
    if (t = Pl(t, 1), e = Z(e, 0, 1), s = Z(s, 0, 1), e === 0)
  ...
  copySRGBToLinear(t) {
    return this.r = Ie(t.r), this.g = Ie(t.g), this.b = Ie(t.b), this;
  }
  copyLinearToSRGB(t) {
  ...
  getHex(t = re) {
    return ee.fromWorkingColorSpace(Ot.copy(this), t), Math.round(Z(Ot.r * 255, 0, 255)) * 65536 + Math.round(Z(Ot.g * 255, 0, 255)) * 256 + Math.round(Z(Ot.b * 255, 0, 255));
  }
  getHexString(t = re) {
    return ("000000" + this.getHex(t).toString(16)).slice(-6);
  }
  getHSL(t, e = ee.workingColorSpace) {
    ee.fromWorkingColorSpace(Ot.copy(this), e);
    const s = Ot.r, i = Ot.g, r = Ot.b, a = Math.max(s, i, r), o = Math.min(s, i, r);
    let c, h;
    const l = (o + a) / 2;
    if (o === a)
      c = 0, h = 0;
  ...
  getRGB(t, e = ee.workingColorSpace) {
    return ee.fromWorkingColorSpace(Ot.copy(this), e), t.r = Ot.r, t.g = Ot.g, t.b = Ot.b, t;
  }
  getStyle(t = re) {
    ee.fromWorkingColorSpace(Ot.copy(this), t);
    const e = Ot.r, s = Ot.g, i = Ot.b;
    return t !== re ? `color(${t} ${e.toFixed(3)} ${s.toFixed(3)} ${i.toFixed(3)})` : `rgb(${Math.round(e * 255)},${Math.round(s * 255)},${Math.round(i * 255)})`;
  }
  offsetHSL(t, e, s) {
    return this.getHSL(ze), this.setHSL(ze.h + t, ze.s + e, ze.l + s);
  }
  add(t) {
    return this.r += t.r, this.g += t.g, this.b += t.b, this;
  }
  ...
  lerpHSL(t, e) {
    this.getHSL(ze), t.getHSL(Ds);
    const s = Gi(ze.h, Ds.h, e), i = Gi(ze.s, Ds.s, e), r = Gi(ze.l, Ds.l, e);
...
const Ot = /* @__PURE__ */ new jn();
jn.NAMES = $c;
let Ql = 0;
class Xc extends _i {
  constructor() {
    super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Ql++ }), this.uuid = qn(), this.name = "", this.type = "Material", this.blending = _a, this.side = Ur, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = Ia, this.blendDst = Ra, this.blendEquation = La, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new jn(0, 0, 0), this.blendAlpha = 0, this.depthFunc = Ba, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = Na, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = bn, this.stencilZFail = bn, this.stencilZPass = bn, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
class Yc extends Xc {
  constructor(t) {
    super(), this.isMeshBasicMaterial = !0, this.type = "MeshBasicMaterial", this.color = new jn(16777215), this.map = null, this.lightMap = null, this.lightMapIntensity = 1, this.aoMap = null, this.aoMapIntensity = 1, this.specularMap = null, this.alphaMap = null, this.envMap = null, this.envMapRotation = new bs(), this.combine = Ll, this.reflectivity = 1, this.refractionRatio = 0.98, this.wireframe = !1, this.wireframeLinewidth = 1, this.wireframeLinecap = "round", this.wireframeLinejoin = "round", this.fog = !0, this.setValues(t);
  }
  copy(t) {
    return super.copy(t), this.color.copy(t.color), this.map = t.map, this.lightMap = t.lightMap, this.lightMapIntensity = t.lightMapIntensity, this.aoMap = t.aoMap, this.aoMapIntensity = t.aoMapIntensity, this.specularMap = t.specularMap, this.alphaMap = t.alphaMap, this.envMap = t.envMap, this.envMapRotation.copy(t.envMapRotation), this.combine = t.combine, this.reflectivity = t.reflectivity, this.refractionRatio = t.refractionRatio, this.wireframe = t.wireframe, this.wireframeLinewidth = t.wireframeLinewidth, this.wireframeLinecap = t.wireframeLinecap, this.wireframeLinejoin = t.wireframeLinejoin, this.fog = t.fog, this;
  }
}
const mt = /* @__PURE__ */ new E(), Us = /* @__PURE__ */ new $();
class he {
  constructor(t, e, s = !1) {
    if (Array.isArray(t))
      throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
    this.isBufferAttribute = !0, this.name = "", this.array = t, this.itemSize = e, this.count = t !== void 0 ? t.length / e : 0, this.normalized = s, this.usage = Ha, this.updateRanges = [], this.gpuType = Dl, this.version = 0;
  }
  onUploadCallback() {
  }
  set needsUpdate(t) {
  ...
  getComponent(t, e) {
    ...
    return this.normalized && (s = Xn(s, this.array)), s;
  }
  setComponent(t, e, s) {
...
class Ht extends _i {
  ...
  setIndex(t) {
    return Array.isArray(t) ? this.index = new (zl(t) ? eu : tu)(t, 1) : this.index = t, this;
  }
  setIndirect(t) {
  ...
  computeTangents() {
    ...
    function O(I) {
      ...
      const V = o[I];
      v.copy(V), v.sub(F.multiplyScalar(F.dot(V))).normalize(), w.crossVectors(M, V);
...
const eo = /* @__PURE__ */ new Tt(), sn = /* @__PURE__ */ new jc(), Ps = /* @__PURE__ */ new ra(), no = /* @__PURE__ */ new E(), zs = /* @__PURE__ */ new E(), Ns = /* @__PURE__ */ new E(), Hs = /* @__PURE__ */ new E(), or = /* @__PURE__ */ new E(), Gs = /* @__PURE__ */ new E(), so = /* @__PURE__ */ new E(), Vs = /* @__PURE__ */ new E();
class cs extends jt {
  constructor(t = new Ht(), e = new Yc()) {
  ...
  getVertexPosition(t, e) {
    ...
    if (r && o) {
      ...
      for (let c = 0, h = r.length; c < h; c++) {
        const l = o[c], u = r[c];
        l !== 0 && (or.fromBufferAttribute(u, t), a ? Gs.addScaledVector(or, l) : Gs.addScaledVector(or.sub(e), l));
      }
      e.add(Gs);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    i !== void 0 && (s.boundingSphere === null && s.computeBoundingSphere(), Ps.copy(s.boundingSphere), Ps.applyMatrix4(r), sn.copy(t.ray).recast(t.near), !(Ps.containsPoint(sn.origin) === !1 && (sn.intersectSphere(Ps, no) === null || sn.origin.distanceToSquared(no) > (t.far - t.near) ** 2)) && (eo.copy(r).invert(), sn.copy(t.ray).applyMatrix4(eo), !(s.boundingBox !== null && sn.intersectsBox(s.boundingBox) === !1) && this._computeIntersections(t, e, sn)));
  }
      ...
      if (Array.isArray(a))
        for (let d = 0, g = f.length; d < g; d++) {
          ...
          for (let w = S, F = v; w < F; w += 3) {
            ...
            i = Ws(this, b, t, s, h, l, u, M, O, I), i && (i.faceIndex = Math.floor(w / 3), i.face.materialIndex = x.materialIndex, e.push(i));
          }
        }
      else {
        const d = Math.max(0, p.start), g = Math.min(o.count, p.start + p.count);
        for (let x = d, b = g; x < b; x += 3) {
          const S = o.getX(x), v = o.getX(x + 1), w = o.getX(x + 2);
          i = Ws(this, a, t, s, h, l, u, S, v, w), i && (i.faceIndex = Math.floor(x / 3), e.push(i));
        }
      }
    else if (c !== void 0)
      if (Array.isArray(a))
        ...
        for (let x = d, b = g; x < b; x += 3) {
          const S = x, v = x + 1, w = x + 2;
          i = Ws(this, a, t, s, h, l, u, S, v, w), i && (i.faceIndex = Math.floor(x / 3), e.push(i));
        }
      }
  }
}
function su(n, t, e, s, i, r, a, o) {
  let c;
  if (t.side === _l ? c = s.intersectTriangle(a, r, i, !0, o) : c = s.intersectTriangle(i, r, a, t.side === Ur, o), c === null) return null;
  Vs.copy(o), Vs.applyMatrix4(n.matrixWorld);
  const h = e.ray.origin.distanceTo(Vs);
...
function Ws(n, t, e, s, i, r, a, o, c, h) {
  n.getVertexPosition(o, zs), n.getVertexPosition(c, Ns), n.getVertexPosition(h, Hs);
  const l = su(n, t, e, s, zs, Ns, Hs, so);
  if (l) {
    const u = new E();
    ce.getBarycoord(so, zs, Ns, Hs, u), i && (l.uv = ce.getInterpolatedAttribute(i, o, c, h, u, new $())), r && (l.uv1 = ce.getInterpolatedAttribute(r, o, c, h, u, new $())), a && (l.normal = ce.getInterpolatedAttribute(a, o, c, h, u, new E()), l.normal.dot(s.direction) > 0 && l.normal.multiplyScalar(-1));
    const f = {
      a: o,
      b: c,
      c: h,
    ...
    ce.getNormal(zs, Ns, Hs, f.normal), l.face = f, l.barycoord = u;
  }
  return l;
}
class Zc extends Xc {
  constructor(t) {
    super(), this.isLineBasicMaterial = !0, this.type = "LineBasicMaterial", this.color = new jn(16777215), this.map = null, this.linewidth = 1, this.linecap = "round", this.linejoin = "round", this.fog = !0, this.setValues(t);
  }
  copy(t) {
    return super.copy(t), this.color.copy(t.color), this.map = t.map, this.linewidth = t.linewidth, this.linecap = t.linecap, this.linejoin = t.linejoin, this.fog = t.fog, this;
  }
}
const fi = /* @__PURE__ */ new E(), pi = /* @__PURE__ */ new E(), io = /* @__PURE__ */ new Tt(), Qn = /* @__PURE__ */ new jc(), qs = /* @__PURE__ */ new ra(), cr = /* @__PURE__ */ new E(), ro = /* @__PURE__ */ new E();
class Pr extends jt {
  constructor(t = new Ht(), e = new Zc()) {
  ...
  computeLineDistances() {
    ...
    if (t.index === null) {
      ...
      for (let i = 1, r = e.count; i < r; i++)
        fi.fromBufferAttribute(e, i - 1), pi.fromBufferAttribute(e, i), s[i] = s[i - 1], s[i] += fi.distanceTo(pi);
      t.setAttribute("lineDistance", new un(s, 1));
    } else
  ...
  raycast(t, e) {
    ...
    if (s.boundingSphere === null && s.computeBoundingSphere(), qs.copy(s.boundingSphere), qs.applyMatrix4(i), qs.radius += r, t.ray.intersectsSphere(qs) === !1) return;
    io.copy(i).invert(), Qn.copy(t.ray).applyMatrix4(io);
    ...
    if (l !== null) {
      ...
      for (let g = p, x = d - 1; g < x; g += h) {
        const b = l.getX(g), S = l.getX(g + 1), v = js(this, t, Qn, c, b, S);
        v && e.push(v);
      }
      if (this.isLineLoop) {
        const g = l.getX(d - 1), x = l.getX(p), b = js(this, t, Qn, c, g, x);
        b && e.push(b);
      }
    } else {
      const p = Math.max(0, a.start), d = Math.min(f.count, a.start + a.count);
      for (let g = p, x = d - 1; g < x; g += h) {
        const b = js(this, t, Qn, c, g, g + 1);
        b && e.push(b);
      }
      if (this.isLineLoop) {
        const g = js(this, t, Qn, c, d - 1, p);
        g && e.push(g);
      }
    }
  }
...
function js(n, t, e, s, i, r) {
  const a = n.geometry.attributes.position;
  if (fi.fromBufferAttribute(a, i), pi.fromBufferAttribute(a, r), e.distanceSqToSegment(fi, pi, cr, ro) > s) return;
...
class Se {
  ...
  computeFrenetFrames(t, e) {
    const s = new E(), i = [], r = [], a = [], o = new E(), c = new Tt();
    for (let p = 0; p <= t; p++) {
      const d = p / t;
...
const $s = /* @__PURE__ */ new E(), hr = /* @__PURE__ */ new aa(), lr = /* @__PURE__ */ new aa(), ur = /* @__PURE__ */ new aa();
class ru extends Se {
...
function is(n, t, e, s, i) {
  return hu(n, t) + lu(n, e) + uu(n, s) + fu(n, i);
}
class di extends Se {
  ...
  getPoint(t, e = new $()) {
    ...
    return s.set(
      is(t, i.x, r.x, a.x, o.x),
      is(t, i.y, r.y, a.y, o.y)
    ), s;
  }
  copy(t) {
...
let zr = class extends mu {
  ...
  lineTo(t, e) {
    const s = new rs(this.currentPoint.clone(), new $(t, e));
  ...
  splineThru(t) {
    const e = [this.currentPoint.clone()].concat(t), s = new Kc(e);
  ...
  absellipse(t, e, s, i, r, a, o, c) {
    const h = new hs(t, e, s, i, r, a, o, c);
...
function Qc(n, t, e, s, i) {
  ...
  return a && Li(a, a.next) && (fs(a), a = a.next), a;
}
function pn(n, t) {
  if (!n) return n;
  t || (t = n);
...
function ls(n, t, e, s, i, r, a) {
  if (!n) return;
  !a && r && Au(n, s, i, r);
  let o = n, c, h;
  for (; n.prev !== n.next; ) {
    if (c = n.prev, h = n.next, r ? bu(n, s, i, r) : xu(n)) {
      t.push(c.i / e | 0), t.push(n.i / e | 0), t.push(h.i / e | 0), fs(n), n = h.next, o = h.next;
      continue;
    }
    if (n = h, n === o) {
      a ? a === 1 ? (n = vu(pn(n), t, e), ls(n, t, e, s, i, r, 2)) : a === 2 && Su(n, t, e, s, i, r) : ls(pn(n), t, e, s, i, r, 1);
      break;
    }
  }
}
function xu(n) {
  ...
  let d = s.next;
  for (; d !== t; ) {
    if (d.x >= l && d.x <= f && d.y >= u && d.y <= p && Rn(i, o, r, c, a, h, d.x, d.y) && lt(d.prev, d, d.next) >= 0) return !1;
    d = d.next;
  }
  return !0;
}
function bu(n, t, e, s) {
  ...
  const o = i.x, c = r.x, h = a.x, l = i.y, u = r.y, f = a.y, p = o < c ? o < h ? o : h : c < h ? c : h, d = l < u ? l < f ? l : f : u < f ? u : f, g = o > c ? o > h ? o : h : c > h ? c : h, x = l > u ? l > f ? l : f : u > f ? u : f, b = Nr(p, d, t, e, s), S = Nr(g, x, t, e, s);
  let v = n.prevZ, w = n.nextZ;
  for (; v && v.z >= b && w && w.z <= S; ) {
    if (v.x >= p && v.x <= g && v.y >= d && v.y <= x && v !== i && v !== a && Rn(o, l, c, u, h, f, v.x, v.y) && lt(v.prev, v, v.next) >= 0 || (v = v.prevZ, w.x >= p && w.x <= g && w.y >= d && w.y <= x && w !== i && w !== a && Rn(o, l, c, u, h, f, w.x, w.y) && lt(w.prev, w, w.next) >= 0)) return !1;
    w = w.nextZ;
  }
  for (; v && v.z >= b; ) {
    if (v.x >= p && v.x <= g && v.y >= d && v.y <= x && v !== i && v !== a && Rn(o, l, c, u, h, f, v.x, v.y) && lt(v.prev, v, v.next) >= 0) return !1;
    v = v.prevZ;
  }
  for (; w && w.z <= S; ) {
    if (w.x >= p && w.x <= g && w.y >= d && w.y <= x && w !== i && w !== a && Rn(o, l, c, u, h, f, w.x, w.y) && lt(w.prev, w, w.next) >= 0) return !1;
    w = w.nextZ;
  }
  return !0;
}
function vu(n, t, e) {
  ...
  do {
    ...
    !Li(i, r) && th(i, s, s.next, r) && us(i, r) && us(r, i) && (t.push(i.i / e | 0), t.push(s.i / e | 0), t.push(r.i / e | 0), fs(s), fs(s.next), s = n = r), s = s.next;
  } while (s !== n);
  return pn(s);
}
function Su(n, t, e, s, i, r) {
  let a = n;
  do {
    let o = a.next.next;
    for (; o !== a.prev; ) {
      if (a.i !== o.i && Ou(a, o)) {
        let c = eh(a, o);
        a = pn(a, a.next), c = pn(c, c.next), ls(a, t, e, s, i, r, 0), ls(c, t, e, s, i, r, 0);
        return;
      }
      o = o.next;
    }
...
function wu(n, t, e, s) {
  ...
  for (r = 0, a = t.length; r < a; r++)
    o = t[r] * s, c = r < a - 1 ? t[r + 1] * s : n.length, h = Qc(n, o, c, s, !1), h === h.next && (h.steiner = !0), i.push(Mu(h));
  for (i.sort(Cu), r = 0; r < i.length; r++)
    e = Tu(i[r], e);
  return e;
}
function Cu(n, t) {
...
function Tu(n, t) {
  ...
  if (!e)
    return t;
  const s = eh(e, n);
  return pn(s, s.next), pn(e, e.next);
}
function Fu(n, t) {
  let e = t, s = -1 / 0, i;
  const r = n.x, a = n.y;
  ...
  e = i;
  do
    r >= e.x && e.x >= c && r !== e.x && Rn(a < h ? r : s, a, c, h, a < h ? s : r, a, e.x, e.y) && (u = Math.abs(a - e.y) / (r - e.x), us(e, n) && (u < l || u === l && (e.x > i.x || e.x === i.x && ku(i, e))) && (i = e, l = u)), e = e.next;
  while (e !== o);
  return i;
}
function ku(n, t) {
...
function Au(n, t, e, s) {
  let i = n;
  do
    i.z === 0 && (i.z = Nr(i.x, i.y, t, e, s)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
  while (i !== n);
...
function Rn(n, t, e, s, i, r, a, o) {
  return (i - a) * (t - o) >= (n - a) * (r - o) && (n - a) * (s - o) >= (e - a) * (t - o) && (e - a) * (r - o) >= (i - a) * (s - o);
}
function Ou(n, t) {
  return n.next.i !== t.i && n.prev.i !== t.i && !_u(n, t) && // doesn't intersect other edges
  (us(n, t) && us(t, n) && Lu(n, t) && // locally visible
...
function th(n, t, e, s) {
  const i = Ys(lt(n, t, e)), r = Ys(lt(n, t, s)), a = Ys(lt(e, s, n)), o = Ys(lt(e, s, t));
  return !!(i !== r && a !== o || i === 0 && Xs(n, e, t) || r === 0 && Xs(n, s, t) || a === 0 && Xs(e, n, s) || o === 0 && Xs(e, t, s));
}
function Xs(n, t, e) {
...
function _u(n, t) {
  let e = n;
  do {
    if (e.i !== n.i && e.next.i !== n.i && e.i !== t.i && e.next.i !== t.i && th(e, e.next, n, t)) return !0;
    e = e.next;
  } while (e !== n);
  return !1;
}
...
function eh(n, t) {
  const e = new Hr(n.i, n.x, n.y), s = new Hr(t.i, t.x, t.y), i = n.next, r = t.prev;
  return n.next = t, t.prev = n, e.next = i, i.prev = e, s.next = e, e.prev = s, r.next = s, s.prev = r, s;
}
function uo(n, t, e, s) {
  const i = new Hr(n, t, e);
...
class hn extends Ht {
  constructor(t = new Dn([new $(0, 0.5), new $(-0.5, -0.5), new $(0.5, -0.5)]), e = 12) {
    ...
    this.setIndex(s), this.setAttribute("position", new un(i, 3)), this.setAttribute("normal", new un(r, 3)), this.setAttribute("uv", new un(a, 2));
    function h(l) {
      const u = i.length / 3, f = l.extractPoints(e);
      let p = f.shape;
      const d = f.holes;
      Ye.isClockWise(p) === !1 && (p = p.reverse());
      for (let x = 0, b = d.length; x < b; x++) {
        const S = d[x];
        Ye.isClockWise(S) === !0 && (d[x] = S.reverse());
      }
      const g = Ye.triangulateShape(p, d);
      for (let x = 0, b = d.length; x < b; x++) {
        const S = d[x];
        p = p.concat(S);
      }
      ...
      for (let x = 0, b = g.length; x < b; x++) {
        const S = g[x], v = S[0] + u, w = S[1] + u, F = S[2] + u;
        s.push(v, w, F), c += 3;
      }
    }
  }
  ...
  static fromJSON(t, e) {
    ...
    return new hn(s, t.curveSegments);
  }
}
function Ru(n, t) {
...
const Du = /* @__PURE__ */ new Bu();
class nh {
  constructor(t) {
    this.manager = t !== void 0 ? t : Du, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {};
  }
  load() {
  }
  loadAsync(t, e) {
...
nh.DEFAULT_MATERIAL_NAME = "__DEFAULT";
const Ee = {};
    ...
    fetch(a).then((h) => {
      if (h.status === 200 || h.status === 0) {
        if (h.status === 0 && console.warn("THREE.FileLoader: HTTP Status 0 received."), typeof ReadableStream > "u" || h.body === void 0 || h.body.getReader === void 0)
          return h;
        const l = Ee[t], u = h.body.getReader(), f = h.headers.get("X-File-Size") || h.headers.get("Content-Length"), p = f ? parseInt(f) : 0, d = p !== 0;
        let g = 0;
        const x = new ReadableStream({
          start(b) {
            S();
            function S() {
              u.read().then(({ done: v, value: w }) => {
                if (v)
                  b.close();
                else {
                  g += w.byteLength;
        ...
        throw new Uu(`fetch for "${h.url}" responded with ${h.status}: ${h.statusText}`, h);
    }).then((h) => {
      switch (c) {
        case "arraybuffer":
...
class sh {
  ...
  moveTo(t, e) {
    return this.currentPath = new zr(), this.subPaths.push(this.currentPath), this.currentPath.moveTo(t, e), this;
  }
  lineTo(t, e) {
  ...
  toShapes(t) {
    ...
    function s(b, S) {
      ...
      for (let F = v - 1, M = 0; M < v; F = M++) {
        let O = S[F], I = S[M], V = I.x - O.x, D = I.y - O.y;
        if (Math.abs(D) > Number.EPSILON) {
          if (D < 0 && (O = S[M], V = -V, I = S[F], D = -D), b.y < O.y || b.y > I.y) continue;
          if (b.y === O.y) {
            if (b.x === O.x) return !0;
          } else {
    ...
    const i = Ye.isClockWise, r = this.subPaths;
      ...
      for (let v = 0, w = f.length; v < w; v++) {
        ...
        for (let M = 0; M < F.length; M++) {
          ...
          for (let V = 0; V < f.length; V++)
            s(O.p, f[V].p) && (v !== V && S++, I ? (I = !1, u[V].push(O)) : b = !0);
          I && u[v].push(O);
        }
      }
      S > 0 && b === !1 && (p = u);
...
class ih {
  constructor(t) {
    this.names = /* @__PURE__ */ new Set(), this.unsupportedChars = {}, this.encoding = t.encoding, t.alias.forEach((e) => this.names.add(e)), this.cache = new zu();
  }
  /**
...
const Nu = (n) => n.substring(n.lastIndexOf(".") + 1), ah = (n) => n.split("/").pop(), Ve = (n) => {
  const t = ah(n);
  if (t) {
  ...
  16777215,
  0
], oh = (n) => Hu[n], Gr = (n, t) => t.some((e) => n instanceof e);
let yo, xo;
function Gu() {
  return yo || (yo = [
    IDBDatabase,
...
function ju(n) {
  return Vu().includes(n) ? function(...t) {
    return n.apply(qr(this), t), fn(this.request);
  } : function(...t) {
    return fn(n.apply(qr(this), t));
  };
}
function $u(n) {
  return typeof n == "function" ? ju(n) : (n instanceof IDBTransaction && qu(n), Gr(n, Gu()) ? new Proxy(n, Wr) : n);
}
function fn(n) {
...
const qr = (n) => Ii.get(n);
function Xu(n, t, { blocked: e, upgrade: s, blocking: i, terminated: r } = {}) {
  const a = indexedDB.open(n, t), o = fn(a);
  return s && a.addEventListener("upgradeneeded", (c) => {
    s(fn(a.result), c.oldVersion, c.newVersion, fn(a.transaction), c);
...
const Yu = ["get", "getKey", "getAll", "getAllKeys", "count"], Zu = ["put", "add", "delete", "clear"], pr = /* @__PURE__ */ new Map();
function bo(n, t) {
  if (!(n instanceof IDBDatabase && !(t in n) && typeof t == "string"))
    return;
  if (pr.get(t))
    return pr.get(t);
  const e = t.replace(/FromIndex$/, ""), s = t !== e, i = Zu.includes(e);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(e in (s ? IDBIndex : IDBObjectStore).prototype) || !(i || Yu.includes(e))
  )
    return;
...
const Ju = ["continue", "continuePrimaryKey", "advance"], vo = {}, jr = /* @__PURE__ */ new WeakMap(), hh = /* @__PURE__ */ new WeakMap(), Ku = {
  get(n, t) {
    if (!Ju.includes(t))
      return n[t];
    let e = vo[t];
    return e || (e = vo[t] = function(...s) {
      jr.set(this, hh.get(this)[t](...s));
    }), e;
  }
};
async function* Qu(...n) {
  ...
  if (t instanceof IDBCursor || (t = await t.openCursor(...n)), !t)
    return;
  t = t;
  const e = new Proxy(t, Ku);
  for (hh.set(e, t), Ii.set(e, qr(t)); t; )
...
const on = {
   ...
   */
  async set(t, e) {
    await (await this.getDatabase()).put(on.fonts, { ...e, name: t });
  }
  /**
   ...
   */
  async get(t) {
    return await (await this.getDatabase()).get(on.fonts, t);
  }
  /**
   ...
   */
  async delete(t) {
    await (await this.getDatabase()).delete(on.fonts, t);
  }
  /**
   ...
   */
  async getAll() {
    return await (await this.getDatabase()).getAll(on.fonts);
  }
  /**
   * Clears all fonts from the cache
   */
  async clear() {
    await (await this.getDatabase()).clear(on.fonts);
  }
  /**
  ...
  async getDatabase() {
    ...
    return this.db ? this.db : (this.db = await Xu(
      qt.DATABASE_NAME,
      qt.DATABASE_VERSION,
      {
...
function tf(n, t) {
  this.source = n, this.sourceIndex = 0, this.tag = 0, this.bitcount = 0, this.dest = t, this.destLen = 0, this.ltree = new ps(), this.dtree = new ps();
}
var uh = new ps(), fh = new ps(), ca = new Uint8Array(30), ha = new Uint16Array(30), ph = new Uint8Array(30), dh = new Uint16Array(30), ef = new Uint8Array([
  16,
  17,
  18,
  0,
  ...
  1,
  15
]), Co = new ps(), de = new Uint8Array(320);
function gh(n, t, e, s) {
  var i, r;
  for (i = 0; i < e; ++i) n[i] = 0;
...
function rf(n, t, e) {
  var s, i, r, a, o, c;
  for (s = me(n, 5, 257), i = me(n, 5, 1), r = me(n, 4, 4), a = 0; a < 19; ++a) de[a] = 0;
  for (a = 0; a < r; ++a) {
    var h = me(n, 3, 0);
    de[ef[a]] = h;
  }
  for (mr(Co, de, 0, 19), o = 0; o < s + i; ) {
    var l = Xr(n, Co);
    switch (l) {
      case 16:
        var u = de[o - 1];
...
function Fo(n, t, e) {
  for (; ; ) {
    ...
    if (s < 256)
      ...
      var i, r, a, o;
      for (s -= 257, i = me(n, ca[s], ha[s]), r = Xr(n, e), a = n.destLen - me(n, ph[r], dh[r]), o = a; o < a + i; ++o)
...
function mh(n, t) {
  var e = new tf(n, t), s, i, r;
  do {
    switch (s = sf(e), i = me(e, 2, 0), i) {
      case 0:
        r = af(e);
        break;
      case 1:
        ...
        break;
      case 2:
        rf(e, e.ltree, e.dtree), r = Fo(e, e.ltree, e.dtree);
        break;
      default:
        r = lh;
    }
...
mn.prototype.addPoint = function(n, t) {
...
mn.prototype.addX = function(n) {
  this.addPoint(n, null);
};
mn.prototype.addY = function(n) {
  this.addPoint(null, n);
};
mn.prototype.addBezier = function(n, t, e, s, i, r, a, o) {
  ...
  for (let f = 0; f <= 1; f++) {
    ...
    if (d === 0) {
      if (p === 0) continue;
      const v = -g / p;
      0 < v && v < 1 && (f === 0 && this.addX(On(c[f], h[f], l[f], u[f], v)), f === 1 && this.addY(On(c[f], h[f], l[f], u[f], v)));
      continue;
    }
    const x = Math.pow(p, 2) - 4 * g * d;
    if (x < 0) continue;
    const b = (-p + Math.sqrt(x)) / (2 * d);
    0 < b && b < 1 && (f === 0 && this.addX(On(c[f], h[f], l[f], u[f], b)), f === 1 && this.addY(On(c[f], h[f], l[f], u[f], b)));
    const S = (-p - Math.sqrt(x)) / (2 * d);
    0 < S && S < 1 && (f === 0 && this.addX(On(c[f], h[f], l[f], u[f], S)), f === 1 && this.addY(On(c[f], h[f], l[f], u[f], S)));
  }
};
mn.prototype.addQuad = function(n, t, e, s, i, r) {
...
xt.prototype.fromSVG = function(n, t = {}) {
  ...
  function h(d) {
    return d.filter((g) => g.length).map((g) => {
      let x = parseFloat(g);
      return (t.decimalPlaces || t.decimalPlaces === 0) && (x = xh(x, t.decimalPlaces)), x;
    });
  }
  function l(d) {
  ...
  function u() {
    ...
    const b = this.commands.length && this.commands[this.commands.length - 1].x || 0, S = this.commands.length && this.commands[this.commands.length - 1].y || 0;
    switch (d) {
      case "M":
        this.moveTo(...x);
        break;
      ...
      case "V":
        for (let v = 0; v < x.length; v++) {
          let w = 0;
          g && (w = this.commands.length && this.commands[this.commands.length - 1].y || 0), this.lineTo(b, x[v] + w);
        }
        break;
      case "H":
        for (let v = 0; v < x.length; v++) {
          let w = 0;
          g && (w = this.commands.length && this.commands[this.commands.length - 1].x || 0), this.lineTo(x[v] + w, S);
        }
        break;
      case "C":
    ...
    if (this.commands.length)
      for (const v in this.commands[this.commands.length - 1])
        this.commands[this.commands.length - 1][v] === void 0 && (this.commands[this.commands.length - 1][v] = 0);
  }
...
\r\f\v`.indexOf(g) > -1 ? o.push("") : g === "." ? !a.type || x.indexOf(g) > -1 ? c = !0 : o[o.length - 1] += g : c = !0;
  ...
  u.apply(this), t.optimize && (this.commands = bh(this.commands));
  const f = t.flipY;
  let p = t.flipYBase;
...
xt.prototype.toPathData = function(n) {
  ...
  let s = this.commands;
  n.optimize && (s = JSON.parse(JSON.stringify(this.commands)), s = bh(s));
  const i = n.flipY;
  let r = n.flipYBase;
  if (i === !0 && r === void 0) {
    const o = new xt();
...
var G = { fail: vh, argument: ko, assert: ko }, Ao = 32768, Eo = 2147483648, hf = -32768, lf = 32767 + 1 / 65536, Hn = {}, z = {}, q = {};
function pe(n) {
  return function() {
    return n;
  };
...
q.USHORT = pe(2);
z.SHORT = function(n) {
  return n >= Ao && (n = -(2 * Ao - n)), [n >> 8 & 255, n & 255];
};
q.SHORT = pe(2);
z.UINT24 = function(n) {
...
Hn.UTF8 = function(n, t, e) {
  const s = [], i = e;
  for (let r = 0; r < i; r++, t += 1)
    s[r] = n.getUint8(t);
  return String.fromCharCode.apply(null, s);
};
Hn.UTF16 = function(n, t, e) {
  const s = [], i = e / 2;
...
var Zs = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), Js, uf = function(n) {
  if (!Js) {
    Js = {};
    for (let i in mi)
      Js[i] = new String(i);
...
z.VARDELTAS = function(n) {
  ...
  for (; t < n.length; ) {
    const s = n[t];
    s === 0 ? t = ff(n, t, e) : s >= -128 && s <= 127 ? t = pf(n, t, e) : t = df(n, t, e);
  }
  return e;
};
z.INDEX = function(n) {
...
z.OP = z.BYTE;
q.OP = q.BYTE;
var Ks = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap();
...
function yi(n) {
  n.format === 1 ? dt.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(Gn("glyph", n.glyphs))
  ) : n.format === 2 ? dt.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 2 }].concat(Vn("rangeRecord", n.ranges, function(t, e) {
      return [
...
function xi(n) {
  dt.call(
    this,
    "scriptListTable",
    Vn("scriptRecord", n, function(t, e) {
      const s = t.script;
      ...
      return G.assert(!!i, "Unable to write GSUB: script " + t.tag + " has no default language system."), [
        ...
        { name: "script" + e, type: "TABLE", value: new dt("scriptTable", [
          ...
          ].concat(Gn("featureIndex", i.featureIndexes))) }
        ].concat(Vn("langSys", s.langSysRecords, function(r, a) {
          const o = r.langSys;
          return [
            ...
            ].concat(Gn("featureIndex", o.featureIndexes))) }
          ];
        }))) }
      ];
    })
...
function bi(n) {
  dt.call(
    this,
    "featureListTable",
    Vn("featureRecord", n, function(t, e) {
      const s = t.feature;
      return [
        ...
        ].concat(Gn("lookupListIndex", s.lookupListIndexes))) }
      ];
    })
  );
}
...
function Si(n) {
  n.format === 1 ? dt.call(
    ...
    ].concat(Gn("glyph", n.classes))
  ) : n.format === 2 ? dt.call(
    this,
    "classDefTable",
    [{ name: "classFormat", type: "USHORT", value: 2 }].concat(Vn("rangeRecord", n.ranges, function(t, e) {
      return [
        { name: "startGlyphID" + e, type: "USHORT", value: t.start },
        { name: "endGlyphID" + e, type: "USHORT", value: t.end },
...
k.prototype.parseUInt24 = function() {
  const n = Sh(this.data, this.offset + this.relativeOffset);
...
k.prototype.parseLong = function() {
  const n = mf(this.data, this.offset + this.relativeOffset);
  return this.relativeOffset += 4, n;
};
k.prototype.parseOffset32 = k.prototype.parseULong;
k.prototype.parseFixed = function() {
  const n = wh(this.data, this.offset + this.relativeOffset);
  return this.relativeOffset += 4, n;
};
k.prototype.parseString = function(n) {
...
k.prototype.parseVersion = function(n) {
...
k.prototype.skip = function(n, t) {
  t === void 0 && (t = 1), this.relativeOffset += Sf[n] * t;
};
k.prototype.parseULongList = function(n) {
...
k.prototype.parseOffset16List = k.prototype.parseUShortList = function(n) {
...
k.prototype.parseShortList = function(n) {
  const t = new Array(n), e = this.data;
  let s = this.offset + this.relativeOffset;
  for (let i = 0; i < n; i++)
...
k.prototype.parseByteList = function(n) {
  const t = new Array(n), e = this.data;
  let s = this.offset + this.relativeOffset;
  for (let i = 0; i < n; i++)
    t[i] = e.getUint8(s++);
...
k.prototype.parseList = function(n, t) {
...
k.prototype.parseList32 = function(n, t) {
...
k.prototype.parseRecordList = function(n, t) {
  t || (t = n, n = this.parseUShort());
...
k.prototype.parseRecordList32 = function(n, t) {
  t || (t = n, n = this.parseULong());
  const e = new Array(n), s = Object.keys(t);
  for (let i = 0; i < n; i++) {
    const r = {};
...
k.prototype.parseTupleRecords = function(n, t) {
  let e = [];
  for (let s = 0; s < n; s++) {
    let i = [];
    for (let r = 0; r < t; r++)
...
k.prototype.parseStruct = function(n) {
...
k.prototype.parseValueRecord = function(n) {
...
k.prototype.parsePointer = function(n) {
  const t = this.parseOffset16();
  if (t > 0)
    return new k(this.data, this.offset + t).parseStruct(n);
};
k.prototype.parsePointer32 = function(n) {
  const t = this.parseOffset32();
  if (t > 0)
    return new k(this.data, this.offset + t).parseStruct(n);
};
k.prototype.parseListOfLists = function(n) {
...
k.prototype.parseScriptList = function() {
  return this.parsePointer(k.recordList({
    tag: k.tag,
    script: k.pointer({
      defaultLangSys: k.pointer(Oo),
      langSysRecords: k.recordList({
        tag: k.tag,
        langSys: k.pointer(Oo)
      })
    })
  })) || [];
};
...
k.prototype.parseLookupList = function(n) {
  return this.parsePointer(k.list(k.pointer(function() {
    ...
    return {
      lookupType: t,
      lookupFlag: e,
      subtables: this.parseList(k.pointer(n[t])),
...
k.prototype.parseDeltaSets = function(n, t, e) {
...
k.prototype.parseTupleVariationStoreList = function(n, t, e) {
...
k.prototype.parseTupleVariationStore = function(n, t, e, s, i) {
  ...
  for (let d = 0; d < c; d++) {
    ...
    Object.defineProperty(g, "deltas", S.call(this, "deltas")), e === "gvar" && Object.defineProperty(g, "deltasY", S.call(this, "deltasY")), f += g.variationDataSize, delete g.variationDataSize;
  }
...
k.prototype.parseTupleVariationHeader = function(n, t) {
...
k.prototype.parsePackedDeltas = function(n) {
  const t = [];
  for (; t.length < n; ) {
...
function Af(n, t, e) {
  ...
  for (let c = 0; c < a; c++) {
    const h = i.parseUShort(), l = i.parseUShort(), u = i.parseUShort(), f = i.parseUShort(), p = Ci[f] || f, d = i.parseUShort(), g = i.parseUShort(), x = Cf(h, u, e), b = ua(h, l, u), S = kf(h);
    if (b !== void 0 && x !== void 0 && S !== void 0) {
      let v;
      if (b === Jr ? v = Hn.UTF16(n, o + g, d) : v = Hn.MACSTRING(n, o + g, d, b), v) {
        let w = s[S];
        w === void 0 && (w = s[S] = {});
        let F = w[p];
        F === void 0 && (F = w[p] = {}), F[x] = v;
      }
    }
  }
...
function Mf(n, t) {
  const e = Qs(Fh), s = Qs(Ch), i = Qs(Th), r = [], a = [];
  for (let c in n) {
    let h;
    const l = [], u = {}, f = Qs(Ci), p = e[c];
    for (let d in n[c]) {
      let g = f[d];
    ...
    for (let d = 0; d < l.length; d++) {
      ...
      for (let x in g) {
        ...
        if (p === 1 || p === 0) {
          let S = s[x], v = wf[S];
          const w = ua(p, v, S);
          let F = z.MACSTRING(b, w);
          if (p === 0 && (S = t.indexOf(x), S < 0 && (S = t.length, t.push(x)), v = 4, F = z.UTF16(b)), F !== void 0) {
            const M = Lo(F, a);
            r.push(_o(
              p,
              v,
...
var kh = { parse: Af, make: Mf, getNameByID: Ti };
function Of(n, t, e, s) {
...
Eh.prototype.charToGlyphIndex = function(n) {
  ...
  switch (n.version) {
    ...
    case 2:
      ...
      for (let t = 0; t < n.numberOfGlyphs; t++)
        n.glyphNameIndex[t] < cn.length ? this.names[t] = cn[n.glyphNameIndex[t]] : this.names[t] = n.names[n.glyphNameIndex[t] - cn.length];
      break;
    case 2.5:
      this.names = new Array(n.numberOfGlyphs);
      for (let t = 0; t < n.numberOfGlyphs; t++)
        this.names[t] = cn[t + n.glyphNameIndex[t]];
      break;
    case 3:
      this.names = [];
      break;
...
var rn = { line: jf };
function $f(n, t) {
  const e = new k(n, t), s = e.parseShort();
...
function Xf({ version: n = 0, numPaletteEntries: t = 0, colorRecords: e = [], colorRecordIndices: s = [0] }) {
...
function pa(n, t, e = 0, s = "hexa") {
  ...
  const a = _h(i.colorRecords[r]);
  return s === "bgra" ? a : Wn(a, s);
}
function ae(n) {
...
function Wn(n, t = "hexa") {
  if (n === "currentColor") return n;
  if (Number.isInteger(n)) {
    if (t == "raw" || t == "cpal")
      return n;
    n = _h(n);
  } else typeof n != "object" && (n = Fi(n, "bgra"));
  let e = ["hsl", "hsla"].includes(t) ? Yf(n) : null;
  switch (t) {
    case "rgba":
...
var Ih = { parse: $f, make: Xf, getPaletteColor: pa, parseColor: Fi, formatColor: Wn };
function Jf(n, t) {
  let e = t || new Nn();
  return {
    configurable: !0,
...
It.prototype.bindConstructorValues = function(n) {
  ...
  this.name = n.name || null, this.unicode = n.unicode, this.unicodes = n.unicodes || (n.unicode !== void 0 ? [n.unicode] : []), "xMin" in n && (this.xMin = n.xMin), "yMin" in n && (this.yMin = n.yMin), "xMax" in n && (this.xMax = n.xMax), "yMax" in n && (this.yMax = n.yMax), "advanceWidth" in n && (this.advanceWidth = n.advanceWidth), "leftSideBearing" in n && (this.leftSideBearing = n.leftSideBearing), "points" in n && (this.points = n.points), Object.defineProperty(this, "path", Jf(this, n.path));
};
  ...
  if (s.drawLayers) {
    ...
    if (f && f.length) {
      ...
      for (let p = 0; p < f.length; p += 1) {
        ...
        g === "currentColor" ? g = s.fill || "black" : g = Wn(g, s.colorFormat || "rgba"), s = Object.assign({}, s, { fill: g }), u._layers.push(this.getPath.call(d.glyph, n, t, e, s, i));
      }
      return u;
    }
  }
...
function Kf(n, t) {
  return new ds({ index: t, font: n });
}
function Qf(n, t, e, s, i, r) {
  return function() {
    const a = new ds({ index: t, font: n });
    return a.path = function() {
      e(a, s, i);
      const o = r(n.glyphs, a);
      return o.unitsPerEm = n.unitsPerEm, o;
    }, _n(a, "numberOfContours", "_numberOfContours"), _n(a, "xMin", "_xMin"), _n(a, "xMax", "_xMax"), _n(a, "yMin", "_yMin"), _n(a, "yMax", "_yMax"), _n(a, "points", "_points"), a;
  };
}
function tp(n, t, e, s, i) {
  return function() {
    const r = new ds({ index: t, font: n });
...
var ve = { GlyphSet: Ri, glyphLoader: Kf, ttfGlyphLoader: Qf, cffGlyphLoader: tp };
function Rh(n, t) {
  if (n === t)
    return !0;
...
function as(n, t) {
  return t <= 390 ? t = ri[t] : n ? t = n[t - 391] : t = void 0, t;
}
function ga(n, t, e) {
  const s = {};
  let i;
  for (let r = 0; r < t.length; r += 1) {
    ...
    if (Array.isArray(a.type)) {
      ...
      for (let c = 0; c < a.type.length; c++)
        i = n[a.op] !== void 0 ? n[a.op][c] : void 0, i === void 0 && (i = a.value !== void 0 && a.value[c] !== void 0 ? a.value[c] : null), a.type[c] === "SID" && (i = as(e, i)), o[c] = i;
      s[a.name] = o;
    } else
      i = n[a.op], i === void 0 && (i = a.value !== void 0 ? a.value : null), a.type === "SID" && (i = as(e, i)), s[a.name] = i;
  }
  return s;
}
function ap(n, t) {
...
function lp(n, t, e, s) {
  ...
  return ga(i, s > 1 ? op : Bh, e);
}
function ma(n, t, e, s, i) {
  const r = da(n, t, e, i);
  return ga(r, i > 1 ? cp : Dh, s);
}
function up(n, t, e) {
...
function fp(n, t, e) {
  const s = [];
  for (let i = 0; i < e.length; i++) {
    const r = new DataView(new Uint8Array(e[i]).buffer), a = up(r, 0, 2), o = a.private[0], c = a.private[1];
    if (o !== 0 && c !== 0) {
      const h = ma(n, c + t, o, [], 2);
      if (h.subrs) {
        const l = c + h.subrs, u = ge(n, l + t, void 0, 2);
        a._subrs = u.objects, a._subrsBias = ki(a._subrs);
      }
      a._privateDict = h;
    }
    s.push(a);
...
function yr(n, t, e, s, i) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const o = new DataView(new Uint8Array(e[a]).buffer), c = lp(o, 0, s, i);
    ...
    if (h !== 0 && l !== 0) {
      ...
      if (c._defaultWidthX = u.defaultWidthX, c._nominalWidthX = u.nominalWidthX, u.subrs !== 0) {
        const f = l + u.subrs, p = ge(n, f + t, void 0, i);
        c._subrs = p.objects, c._subrsBias = ki(c._subrs);
      }
      c._privateDict = u;
    }
    r.push(c);
...
function pp(n, t, e, s, i) {
  ...
  if (h === 0)
    for (let l = 0; l < e; l += 1)
      r = o.parseSID(), i ? c.push(r) : c.push(as(s, r) || r);
  else if (h === 1)
    for (; c.length <= e; ) {
      r = o.parseSID(), a = o.parseCard8();
      for (let l = 0; l <= a; l += 1)
        i ? c.push("cid" + ("00000" + r).slice(-5)) : c.push(as(s, r) || r), r += 1;
    }
  else if (h === 2)
    for (; c.length <= e; ) {
...
function Qr(n, t, e, s, i) {
  ...
  if (S = I.topDict._defaultWidthX, v = I.topDict._nominalWidthX, i = i || n.variation && n.variation.get(), t.getBlendPath || (t.getBlendPath = function(U) {
    ...
    x = P._subrs, b = P._subrsBias, s > 1 ? (F = I.topDict._vstore.itemVariationStore, w = P._privateDict.vsindex) : (S = P._defaultWidthX, v = P._nominalWidthX);
  } else
    ...
    for (; ct < U.length; ) {
      ...
      switch (ct += 1, At) {
        ...
        case 3:
          ...
          break;
        case 4:
          l.length > 1 && !f && (D = l.shift() + v, f = !0), g += l.pop(), W(d, g);
          break;
        case 5:
          for (; l.length > 0; )
        ...
        case 14:
          ...
          if (l.length >= 4) {
            const we = Kr[l.pop()], C = Kr[l.pop()], m = l.pop(), y = l.pop();
            if (we && C) {
              t.isComposite = !0, t.components = [];
              const T = n.cffEncoding.charset.indexOf(we), A = n.cffEncoding.charset.indexOf(C);
              t.components.push({
                glyphIndex: A,
                dx: 0,
                dy: 0
          ...
          } else l.length > 0 && !f && (D = l.shift() + v, f = !0);
        ...
        case 21:
          ...
          break;
        case 22:
          l.length > 1 && !f && (D = l.shift() + v, f = !0), d += l.pop(), W(d, g);
          break;
        case 23:
          J();
          break;
...
function mp(n, t, e, s) {
  ...
  const a = r.formatMajor > 1 ? null : ge(n, r.endOffset, N.bytesToString), o = r.formatMajor > 1 ? null : ge(n, a.endOffset), c = r.formatMajor > 1 ? null : ge(n, o.endOffset, N.bytesToString), h = ge(n, r.formatMajor > 1 ? t + r.size + r.topDictLength : c.endOffset, void 0, r.formatMajor);
  e.gsubrs = h.objects, e.gsubrsBias = ki(e.gsubrs);
  let l;
  if (r.formatMajor > 1) {
  ...
  if (i.topDict = l, l._privateDict && (e.defaultWidthX = l._privateDict.defaultWidthX, e.nominalWidthX = l._privateDict.nominalWidthX), r.formatMajor < 2 && l.ros[0] !== void 0 && l.ros[1] !== void 0 && (e.isCIDFont = !0), r.formatMajor > 1) {
    ...
    const d = ge(n, t + f, null, r.formatMajor), g = fp(n, t, d.objects);
    ...
    f += t;
    const d = ge(n, f), g = yr(n, t, d.objects, c.objects, r.formatMajor);
  ...
  if (r.formatMajor < 2) {
    ...
    if (e.defaultWidthX = p.defaultWidthX, e.nominalWidthX = p.nominalWidthX, p.subrs !== 0) {
      const d = f + p.subrs, g = ge(n, d);
      e.subrs = g.objects, e.subrsBias = ki(e.subrs);
    } else
      e.subrs = [], e.subrsBias = 0;
  }
  let u;
  if (s.lowMemory ? (u = ep(n, t + l.charStrings, r.formatMajor), e.nGlyphs = u.offsets.length - (r.formatMajor > 1 ? 1 : 0)) : (u = ge(n, t + l.charStrings, null, r.formatMajor), e.nGlyphs = u.objects.length), r.formatMajor > 1 && e.tables.maxp && e.nGlyphs !== e.tables.maxp.numGlyphs && console.error(`Glyph count in the CFF2 table (${e.nGlyphs}) must correspond to the glyph count in the maxp table (${e.tables.maxp.numGlyphs})`), r.formatMajor < 2) {
    let f = [], p = [];
    l.charset === 0 ? f = zf : l.charset === 1 ? f = Nf : l.charset === 2 ? f = Hf : f = pp(n, t + l.charset, e.nGlyphs, c.objects, e.isCIDFont), l.encoding === 0 ? p = Kr : l.encoding === 1 ? p = Gf : p = dp(n, t + l.encoding), e.cffEncoding = new Oh(p, f), e.encoding = e.encoding || e.cffEncoding;
  }
  if (e.glyphs = new ve.GlyphSet(e), s.lowMemory)
    e._push = function(f) {
      const p = np(f, u.offsets, n, t + l.charStrings, void 0, r.formatMajor);
      e.glyphs.push(f, ve.cffGlyphLoader(e, f, Qr, p, r.formatMajor));
    };
  else
...
function Ph(n, t) {
  let e, s = ri.indexOf(n);
  return s >= 0 && (e = s), s = t.indexOf(n), s >= 0 ? e = s + ri.length : (e = ri.length + t.length, t.push(n)), e;
}
function yp() {
...
function zh(n, t, e) {
  ...
  for (let i = 0; i < n.length; i += 1) {
    const r = n[i];
    let a = t[r.name];
    a !== void 0 && !Rh(a, r.value) && (r.type === "SID" && (a = Ph(a, e)), s[r.op] = { name: r.name, type: r.type, value: a });
  }
  return s;
}
function Bo(n, t, e) {
...
function Fp(n, t) {
  ...
  const h = [];
  e.header = yp(), e.nameIndex = xp([t.postScriptName]);
  let l = Bo(i, h);
  e.topDictIndex = Do(l), e.globalSubrIndex = vp(), e.charsets = Sp(o, h), e.charStringsIndex = Cp(n), e.privateDict = Tp(a, h), e.stringIndex = bp(h);
...
function Lp(n, t, e, s, i, r, a) {
  a.lowMemory ? _p(n, t, e, s, i) : Op(t, e, s, i, r);
}
function Ip(n) {
...
var na = { parse: zp, make: Np, unicodeRanges: ea, getUnicodeRange: Pp };
function Hp(n, t) {
  const e = {}, s = new N.Parser(n, t);
  switch (e.version = s.parseVersion(), e.italicAngle = s.parseFixed(), e.underlinePosition = s.parseShort(), e.underlineThickness = s.parseShort(), e.isFixedPitch = s.parseULong(), e.minMemType42 = s.parseULong(), e.maxMemType42 = s.parseULong(), e.minMemType1 = s.parseULong(), e.maxMemType1 = s.parseULong(), e.version) {
    ...
    case 2:
      ...
      e.names = [];
      for (let i = 0; i < e.numberOfGlyphs; i++)
        if (e.glyphNameIndex[i] >= cn.length) {
          const r = s.parseChar();
...
var qh = { parse: Hp, make: Gp }, ue = new Array(9);
ue[1] = function() {
...
ue[5] = function() {
  ...
  if (e === 3) {
    ...
    return {
      substFormat: e,
      coverages: this.parseList(s, k.pointer(k.coverage)),
      lookupRecords: this.parseRecordList(i, Un)
    };
  }
...
ue[7] = function() {
  ...
  const e = this.parseUShort(), s = new k(this.data, this.offset + this.parseULong());
  return {
    substFormat: 1,
    lookupType: e,
    extension: ue[e].call(s)
  };
};
ue[8] = function() {
  const t = this.parseUShort();
...
function Vp(n, t) {
  t = t || 0;
  const e = new k(n, t), s = e.parseVersion(1);
...
function Wp(n) {
  return new L.Table("GSUB", [
    ...
    { name: "lookups", type: "TABLE", value: new L.LookupList(n.lookups, yn) }
  ]);
}
var jh = { parse: Vp, make: Wp };
function qp(n, t) {
  const e = new N.Parser(n, t), s = e.parseULong();
...
var $h = { parse: qp, make: jp };
function $p(n, t) {
  const e = new k(n, t), s = e.parseUShort();
...
function Xp({ version: n = 0, baseGlyphRecords: t = [], layerRecords: e = [] }) {
...
function Qp(n, t) {
  ...
  for (let i = 0; i < n.axes.length; i++)
    e.fields = e.fields.concat(Yp(i, n.axes[i]));
  const s = {};
...
function td(n, t, e) {
  ...
  for (let p = 0; p < a; p++)
    l.push(Zp(n, t + r + p * o, e));
  const u = [], f = t + r + a * o;
  for (let p = 0; p < c; p++)
    u.push(Kp(n, f + p * h, l, e, h));
  return { axes: l, instances: u };
}
var Yh = { make: Qp, parse: td }, ed = {
  tag: k.tag,
  nameID: k.uShort,
  ordering: k.uShort
}, vs = new Array(5);
...
function nd() {
  const n = this.parseUShort(), t = vs[n], e = {
    format: n
  };
...
function sd(n, t, e) {
  ...
  const p = [];
  for (let x = 0; x < c; x++)
    s.offset = t + h, s.relativeOffset = x * o, p.push(s.parseStruct(ed));
  s.offset = t, s.relativeOffset = u;
  const d = s.parseUShortList(l), g = [];
  for (let x = 0; x < l; x++)
    s.offset = t + u, s.relativeOffset = d[x], g.push(nd.apply(s));
  return {
    version: a,
    axes: p,
    values: g,
...
function cd(n, t) {
  ...
  for (let i = 0; i < t.axisValueMaps.length; i++) {
    const r = od(`${n}_${i}`, t.axisValueMaps[i]);
    s = s.concat(r.fields);
  }
...
function hd(n, t) {
  ...
  for (let s = 0; s < n.axisSegmentMaps.length; s++) {
    const i = cd(s, n.axisSegmentMaps[s]);
...
function ld(n, t, e) {
  t || (t = 0);
  const s = new k(n, t), i = s.parseUShort(), r = s.parseUShort();
...
var tl = { parse: gd, make: md };
function yd(n, t) {
  const e = /* @__PURE__ */ new Map(), s = n.buffer, i = new k(n, t);
...
function vd(n) {
  ...
  }), S = Wh.make(n.glyphs.length), v = na.make(Object.assign({
  ...
  }, n.tables.os2)), w = Gh.make(n.glyphs), F = Ah.make(n.glyphs), M = n.getEnglishName("fontFamily"), O = n.getEnglishName("fontSubfamily"), I = M + " " + O;
...
var Sd = { make: nl, fontToTable: vd, computeCheckSum: ya };
function xr(n, t) {
...
ws.prototype.getKerningTables = function(n, t) {
...
function Ad(n) {
  ...
  return mh(n.subarray(e, s), new Uint8Array(r));
}
function Go(n) {
  return {
    x: n.x,
...
var Md = $t, rl = class {
  ...
  getAll(n) {
    ...
    for (let s = 0; s < e.colorRecordIndices.length; s++) {
      ...
      for (let a = i; a < i + e.numPaletteEntries; a++)
        r.push(Wn(e.colorRecords[a], n || "hexa"));
      t.push(r);
    }
    return t;
  }
   ...
   */
  toCPALcolor(n) {
    return Array.isArray(n) ? n.map((t) => Fi(t, "raw")) : Fi(n, "raw");
  }
  /**
  ...
  get(n) {
    ...
    if (!s || !i)
      return e;
    const r = Td(s.baseGlyphRecords, "glyphID", n);
    if (!r)
      return e;
  ...
  updateColrTable(n, t) {
    ...
    let i = Fd(s.baseGlyphRecords, "glyphID", n);
    if (i === -1) {
      const l = { glyphID: n, firstLayerIndex: s.layerRecords.length, numLayers: 0 };
      i = kd(s.baseGlyphRecords, "glyphID", l);
    }
  ...
  getOrCreateSvgImageCacheEntry(n) {
    ...
    s === void 0 && (s = Ld(e), this.cache.set(e, s));
    let i = s.images.get(n);
    return i === void 0 && (i = Id(this.font, s.template, n), i.promise.then((r) => {
...
function Id(n, t, e) {
  return {
    promise: t.then((s) => {
      ...
      const r = Pd(i, n.unitsPerEm);
      return r.image.decode().then(() => r);
    }),
    image: void 0
  };
}
var Rd = typeof DecompressionStream == "function" ? Dd : Bd;
function Bd(n) {
  try {
    return Promise.resolve(new TextDecoder().decode(il(n) ? Ad(n) : n));
  } catch (t) {
      ...
      for (let s = 0; s < t.components.length; s += 1) {
        ...
        if (r.getPath(), r.points) {
          ...
          if (i.matchedPoints === void 0)
            ...
            c = ai([c], h)[0], h.dx = o.x - c.x, h.dy = o.y - c.y, a = ai(r.points, h);
          }
...
function Nd(n, t, e, s) {
  const i = new ve.GlyphSet(s);
  for (let r = 0; r < e.length - 1; r += 1) {
    const a = e[r], o = e[r + 1];
    a !== o ? i.push(r, ve.ttfGlyphLoader(s, r, al, n, t + a, ol)) : i.push(r, ve.glyphLoader(s, r));
  }
  return i;
}
function Hd(n, t, e, s) {
...
function Gd(n, t, e, s, i) {
  return i.lowMemory ? Hd(n, t, e, s) : Nd(n, t, e, s);
}
var cl = { getPath: ba, parse: Gd }, Vd = class {
  constructor(n) {
    this.font = n;
  }
  /**
  ...
  transformComponents(n, t, e, s, i, r) {
    ...
    for (let o = 0; o < n.components.length; o++) {
      const c = n.components[o], h = this.font.glyphs.get(c.glyphIndex), l = Ed(c), u = s.indexOf(o);
      u > -1 && (l.dx += Math.round(i.deltas[u] * r), l.dy += Math.round(i.deltasY[u] * r));
      const f = ai(this.getTransform(h, e).points, l);
    ...
    for (let l = 0; l < a.length; l++) {
      ...
      if (s === "gvar" && i.glyph && i.glyph.isComposite)
        ...
        for (let x = 0; x < p.length; x++) {
          ...
          if (b < t.length) {
            let S = d[b];
            s === "gvar" ? (g[b] = !0, S.x += u.deltas[x] * f, S.y += u.deltasY[x] * f) : s === "cvar" && (h[b] = Math.round(S + u.deltas[x] * f));
          }
        }
        if (s === "gvar") {
          this.interpolatePoints(d, h, g);
          for (let x = 0; x < t.length; x++) {
            let b = d[x].x - h[x].x, S = d[x].y - h[x].y;
            h[x].x = Math.round(h[x].x + b), h[x].y = Math.round(h[x].y + S);
          }
        }
      }
    }
    ...
    if (e || s) {
      if (t || (t = this.font.variation.get()), s) {
        ...
        if (r) {
          ...
          i = new ds(Object.assign({}, n, { points: o, path: ba(o) }));
        }
      } else if (e) {
        const r = n.getBlendPath(t);
        i = new ds(Object.assign({}, n, { path: r }));
      }
    }
  ...
  constructor(n) {
    this.font = n, this.process = new Vd(this.font), this.activateDefaultVariation(), this.getTransform = this.process.getTransform.bind(this.process);
  }
  /**
...
}, Wo = 1e6, Ai = 64, Ei = 1e4, hl, dn, ll, sa;
function ul(n) {
  this.font = n, this.getCommands = function(t) {
    return cl.getPath(t).commands;
...
var pl = function(n) {
  ...
  interpolate: function(n, t, e, s) {
    ...
    if (i = s.distance(n, t, !0, !0), r = s.distance(n, e, !0, !0), c = s.distance(t, t, !1, !0), h = s.distance(e, e, !1, !0), a = Math.abs(i), o = Math.abs(r), l = a + o, l === 0) {
      Le.setRelative(n, n, (c + h) / 2, s, !0);
      return;
    }
    Le.setRelative(n, n, (c * o + h * a) / l, s, !0);
  },
  // Slope of line normal to this.
  normalSlope: 0,
  // Sets the point 'p' relative to point 'rp'
...
Cs.prototype.distance = function(n, t, e, s) {
  return this.x * be.distance(n, t, e, s) + this.y * Le.distance(n, t, e, s);
};
Cs.prototype.interpolate = function(n, t, e, s) {
  let i, r, a, o, c, h, l;
...
Cs.prototype.setRelative = function(n, t, e, s, i) {
  s = s || this;
...
Cs.prototype.touch = function(n) {
  n.xTouched = !0, n.yTouched = !0;
};
function Ts(n, t) {
  const e = Math.sqrt(n * n + t * t);
  return n /= e, t /= e, n === 1 && t === 0 ? be : n === 0 && t === 1 ? Le : new Cs(n, t);
}
function Re(n, t, e, s) {
...
var gs = Object.freeze(new Re(0, 0)), Zd = {
  cvCutIn: 17 / 16,
...
function $e(n, t) {
  switch (this.env = n, this.stack = [], this.prog = t, n) {
    ...
    case "prep":
      this.fv = this.pv = this.dpv = be, this.round = fl;
  }
}
ul.prototype.exec = function(n, t) {
  if (typeof t != "number")
  ...
  if (!s || s.ppem !== t) {
    ...
    if (!i) {
      $e.prototype = Zd, i = this._fpgmState = new $e("fpgm", e.tables.fpgm), i.funcs = [], i.font = e, i.instructionCount = 0, i.callDepth = 0;
      try {
        dn(i);
      } catch (a) {
    ...
    $e.prototype = i, s = this._prepState = new $e("prep", e.tables.prep), s.ppem = t, s.instructionCount = 0, s.callDepth = 0;
...
ll = function(n, t) {
  ...
  if ($e.prototype = t, !i)
    o = new $e("glyf", n.instructions), o.instructionCount = 0, o.callDepth = 0, sa(n, o, e, s), a = o.gZone;
  else {
    const c = t.font;
    a = [], r = [];
    for (let h = 0; h < i.length; h++) {
      const l = i[h], u = c.glyphs.get(l.glyphIndex);
      o = new $e("glyf", u.instructions), o.instructionCount = 0, o.callDepth = 0, sa(u, o, e, s);
      const f = Math.round(l.dx * e), p = Math.round(l.dy * s), d = o.gZone, g = o.contours;
      for (let b = 0; b < d.length; b++) {
        const S = d[b];
        S.xTouched = S.yTouched = !1, S.xo = S.x = S.x + f, S.yo = S.y = S.y + p;
      }
      const x = a.length;
      a.push.apply(a, d);
...
function Xo(n, t) {
  ...
  let o, c;
  n ? (o = r.y - a.y, c = a.x - r.x) : (o = a.x - r.x, c = a.y - r.y), t.pv = t.dpv = Ts(o, c);
}
function Yo(n, t) {
  const e = t.stack, s = e.pop(), i = e.pop(), r = t.z2[s], a = t.z1[i];
  let o, c;
  n ? (o = r.y - a.y, c = a.x - r.x) : (o = a.x - r.x, c = a.y - r.y), t.fv = Ts(o, c);
}
function Jd(n) {
...
function S0(n) {
  ...
  let s = t.pop();
  if (s > Ei && (s = Ei), ++n.callDepth > Ai)
    throw new Error("Hinting call depth exceeded maximum of " + Ai);
...
function Zo(n, t) {
  ...
  let a = r.distance(s, gs);
  n && (a = t.round(a)), i.setRelative(s, gs, a, r), i.touch(s), t.rp0 = t.rp1 = e;
}
function Jo(n, t) {
...
function nc(n, t) {
  ...
  let c = t.cvt[s], h = o.distance(r, gs);
  n && (Math.abs(h - c) < t.cvCutIn && (h = c), h = t.round(h)), a.setRelative(r, gs, h, o), t.zp0 === 0 && (r.xo = r.x, r.yo = r.y), a.touch(r), t.rp0 = t.rp1 = i;
}
function O0(n) {
  const t = n.prog;
  let e = n.ip;
...
function sc(n, t) {
  ...
  e.push(t.dpv.distance(i, gs, n, !1) * 64);
}
function ic(n, t) {
...
function rc(n, t) {
  const e = t.stack, s = e.pop(), i = e.pop(), r = t.z2[s], a = t.z1[i];
  let o, c;
  n ? (o = r.y - a.y, c = a.x - r.x) : (o = a.x - r.x, c = a.y - r.y), t.dpv = Ts(o, c);
}
function d1(n) {
  const t = n.stack, e = t.pop();
  let s = 0;
...
function pt(n) {
  this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, this.registeredModifiers = [], w1.call(this, n);
}
...
function G1(n, t, e) {
  n instanceof qe && ac[n.id] && ac[n.id](n, t, e);
}
var xn = G1;
function V1(n) {
  let t = [].concat(n.backtrack);
  for (let e = t.length - 1; e >= 0; e--) {
    const s = t[e], i = gl(s), r = Je(s);
    if (!i && !r) return !0;
    if (i) return !1;
  }
  return !1;
...
function q1(n) {
  ...
  for (let a = 0; a < s.length; a++) {
    ...
    for (let u = 0; u < l.length; u++) {
      const f = l[u];
      f instanceof qe && (xn(f, s, u), i.context[u] = f.substitution);
    }
  }
}
var j1 = q1;
...
function tg(n) {
  ...
  return (
    // ? latin first char
    e === null && ci(t) || // ? latin char preceded with a non latin char
    !ci(e) && ci(t)
  );
}
function eg(n) {
...
function rg(n) {
  ...
  return (
    // ? thai first char
    e === null && oi(t) || // ? thai char preceded with a non thai char
    !oi(e) && oi(t)
  );
}
function ag(n) {
...
var xg = yg;
function te(n) {
  this.baseDir = n || "ltr", this.tokenizer = new C1(), this.featuresTags = {};
}
te.prototype.setText = function(n) {
  this.text = n;
};
te.prototype.contextChecks = {
  ccmpReplacementCheck: J1,
  latinWordCheck: ng,
  arabicWordCheck: B1,
  arabicSentenceCheck: P1,
  thaiWordCheck: og,
  unicodeVariationSequenceCheck: mg
};
function Ln(n) {
...
function bg() {
  return Ln.call(this, "ccmpReplacement"), Ln.call(this, "latinWord"), Ln.call(this, "arabicWord"), Ln.call(this, "arabicSentence"), Ln.call(this, "thaiWord"), Ln.call(this, "unicodeVariationSequence"), this.tokenizer.tokenize(this.text);
}
function vg() {
...
te.prototype.applyFeatures = function(n, t) {
  ...
  this.query || (this.query = new L1(n));
  for (let e = 0; e < t.length; e++) {
    const s = t[e];
...
function kg() {
  ...
  for (let t = 0; t < n.length; t++) {
    const e = n[t];
    this.hasFeatureEnabled("thai", "liga") && ug.call(this, e), this.hasFeatureEnabled("thai", "rlig") && pg.call(this, e), this.hasFeatureEnabled("thai", "ccmp") && hg.call(this, e);
  }
}
...
te.prototype.applyFeaturesToContexts = function() {
  this.checkContextReady("ccmpReplacement") && wg.call(this), this.checkContextReady("arabicWord") && (Sg.call(this), Cg.call(this)), this.checkContextReady("latinWord") && Tg.call(this), this.checkContextReady("arabicSentence") && vg.call(this), this.checkContextReady("thaiWord") && kg.call(this), this.checkContextReady("unicodeVariationSequence") && Fg.call(this);
};
te.prototype.hasFeatureEnabled = function(n, t) {
  return (this.featuresTags[n] || []).indexOf(t) !== -1;
};
te.prototype.processText = function(n) {
  (!this.text || this.text !== n) && (this.setText(n), bg.call(this), this.applyFeaturesToContexts());
};
...
function st(n) {
  if (n = n || {}, n.tables = n.tables || {}, !n.empty) {
    ...
    this.names = {}, this.names.unicode = Fr(n), this.names.macintosh = Fr(n), this.names.windows = Fr(n), this.unitsPerEm = n.unitsPerEm || 1e3, this.ascender = n.ascender, this.descender = n.descender, this.createdTimestamp = n.createdTimestamp, this.italicAngle = n.italicAngle || 0, this.weightClass = n.weightClass || 0;
    let t = 0;
  ...
  this.supported = !0, this.glyphs = new ve.GlyphSet(this, n.glyphs || []), this.encoding = new Eh(this), this.position = new wd(this), this.substitution = new Md(this), this.tables = this.tables || {}, this.tables = new Proxy(this.tables, {
    set: (t, e, s) => (t[e] = s, t.fvar && (t.gvar || t.cff2) && !this.variation && (this.variation = new Wd(this)), !0)
  }), this.palettes = new rl(this), this.layers = new Od(this), this.svgImages = new _d(this), this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
    get: function() {
      return this._hinting ? this._hinting : this.outlinesFormat === "truetype" ? this._hinting = new v1(this) : null;
    }
  });
}
st.prototype.hasChar = function(n) {
  return this.encoding.charToGlyphIndex(n) > 0;
};
st.prototype.charToGlyphIndex = function(n) {
  return this.encoding.charToGlyphIndex(n);
};
st.prototype.charToGlyph = function(n) {
  const t = this.charToGlyphIndex(n);
  let e = this.glyphs.get(t);
  return e || (e = this.glyphs.get(0)), e;
};
st.prototype.updateFeatures = function(n) {
  return this.defaultRenderOptions.features.map((t) => t.script === "latn" ? {
    script: "latn",
    tags: t.tags.filter((e) => n[e])
  } : t);
};
st.prototype.stringToGlyphIndexes = function(n, t) {
  const e = new Ag(), s = (r) => this.charToGlyphIndex(r.char);
...
st.prototype.stringToGlyphs = function(n, t) {
...
st.prototype.nameToGlyphIndex = function(n) {
  return this.glyphNames.nameToGlyphIndex(n);
};
st.prototype.nameToGlyph = function(n) {
  const t = this.nameToGlyphIndex(n);
  let e = this.glyphs.get(t);
  return e || (e = this.glyphs.get(0)), e;
};
st.prototype.glyphIndexToName = function(n) {
  return this.glyphNames.glyphIndexToName ? this.glyphNames.glyphIndexToName(n) : "";
};
st.prototype.getKerningValue = function(n, t) {
...
st.prototype.defaultRenderOptions = {
  kerning: !0,
  features: [
    /**
...
st.prototype.forEachGlyph = function(n, t, e, s, i, r) {
...
st.prototype.getPath = function(n, t, e, s, i) {
  i = Object.assign({}, this.defaultRenderOptions, i);
  const r = new Nn();
  if (r._layers = [], Uh(this, r), r.stroke) {
...
st.prototype.getPaths = function(n, t, e, s, i) {
  i = Object.assign({}, this.defaultRenderOptions, i);
  const r = [];
...
st.prototype.toTables = function() {
  return Sd.fontToTable(this);
};
st.prototype.toBuffer = function() {
  return console.warn("Font.toBuffer is deprecated. Use Font.toArrayBuffer instead."), this.toArrayBuffer();
};
st.prototype.toArrayBuffer = function() {
  const t = this.toTables().encode(), e = new ArrayBuffer(t.length), s = new Uint8Array(e);
  for (let i = 0; i < t.length; i++)
    s[i] = t[i];
  return e;
};
st.prototype.download = function() {
  console.error("DEPRECATED: platform-specific actions are to be implemented on user-side");
};
st.prototype.fsSelectionValues = {
  ITALIC: 1,
  //1
  UNDERSCORE: 2,
  //2
...
var _g = { make: Og, parse: Mg }, Lg = function() {
  return {
    coverage: this.parsePointer(k.coverage),
  ...
  return this.parseList(k.pointer(Ig));
}, Bg = function() {
  return {
    coverage: this.parsePointer(k.coverage),
    ligGlyphs: this.parseList(k.pointer(Rg))
  };
}, Dg = function() {
...
function Ug(n, t) {
  ...
  var i = {
    version: s,
    classDef: e.parsePointer(k.classDef),
    attachList: e.parsePointer(Lg),
    ligCaretList: e.parsePointer(Bg),
    markAttachClassDef: e.parsePointer(k.classDef)
  };
  return s >= 1.2 && (i.markGlyphSets = e.parsePointer(Dg)), i;
}
var Pg = { parse: Ug }, fe = new Array(10);
fe[1] = function() {
  const t = this.offset + this.relativeOffset, e = this.parseUShort();
  if (e === 1)
    return {
...
fe[2] = function() {
  ...
  const s = this.parsePointer(k.coverage), i = this.parseUShort(), r = this.parseUShort();
  if (e === 1)
    return {
      posFormat: e,
      coverage: s,
  ...
  if (e === 2) {
    const a = this.parsePointer(k.classDef), o = this.parsePointer(k.classDef), c = this.parseUShort(), h = this.parseUShort();
    return {
      ...
      class1Count: c,
      class2Count: h,
      classRecords: this.parseList(c, k.list(h, function() {
        return {
          value1: this.parseValueRecord(i),
          value2: this.parseValueRecord(r)
        };
...
function Hg(n) {
  return new L.Table("GPOS", [
    ...
    { name: "scripts", type: "TABLE", value: new L.ScriptList(n.scripts) },
    { name: "features", type: "TABLE", value: new L.FeatureList(n.features) },
    { name: "lookups", type: "TABLE", value: new L.LookupList(n.lookups, Ng) }
  ]);
}
var Gg = { parse: zg, make: Hg };
function Vg(n) {
  const t = {};
  n.skip("uShort");
...
function Zg(n, t = {}) {
  ...
  let h, l, u, f, p, d, g, x, b, S, v, w, F, M, O, I, V, D;
  for (let B = 0; B < a; B += 1) {
    const U = o[B];
    let P;
    switch (U.tag) {
...
function Jg(n, t = 1e-4) {
  ...
  for (let S = 0; S < r; S++) {
    ...
    for (let F = 0, M = o.length; F < M; F++) {
      const O = o[F], I = n.getAttribute(O), V = I.itemSize;
      for (let D = 0; D < V; D++)
        w += `${~~(I[u[D]](v) * g + x)},`;
    }
    if (w in e)
      ...
      for (let F = 0, M = o.length; F < M; F++) {
        const O = o[F], I = n.getAttribute(O), V = n.morphAttributes[O], D = I.itemSize, W = c[O], J = h[O];
        for (let B = 0; B < D; B++) {
          const U = u[B], P = f[B];
          if (W[P](a, I[U](v)), V)
  ...
  for (const S in n.attributes) {
    const v = c[S];
    if (b.setAttribute(S, new v.constructor(
      v.array.slice(0, a * v.itemSize),
      v.itemSize,
      v.normalized
    )), S in h)
      for (let w = 0; w < h[S].length; w++) {
        const F = h[S][w];
        b.morphAttributes[S][w] = new F.constructor(
...
class yc extends rh {
  ...
  toGeometry() {
    ...
    if (t == null) {
      ...
      return t = new hn(e, 4), mc(t) ? (t.hasAttribute("uv") && t.deleteAttribute("uv"), t.hasAttribute("normal") && t.deleteAttribute("normal"), Jg(t, 1e-6)) : (t.dispose(), new Ht());
    }
...
class em extends Kg {
  ...
  generateShapes(t, e = 100, s = "ltr") {
    const i = [];
    return nm(t, e, this.data, s).forEach((a) => {
      i.push(...hm(a));
    }), i;
  }
}
function nm(n, t, e, s = "ltr") {
...
function rm(n) {
  ...
  for (let s = 0; s < t; s++) {
    let i = null, r = 1 / 0;
    for (let a = 0; a < t; a++)
      if (s !== a && n[s].every((o) => im(o, n[a]))) {
        const o = Math.abs(Ye.area(n[a]));
        o < r && (r = o, i = a);
      }
    e[s] = i;
  }
...
function cm(n) {
  ...
  for (let e = n.length - 1; e >= 0; e--) {
    const s = n[e];
    if (s instanceof rs)
      t.push(new rs(s.v2.clone(), s.v1.clone()));
      ...
      for (let r = i.length - 1; r > 0; r--)
        t.push(new rs(i[r].clone(), i[r - 1].clone()));
    }
  }
  return t;
}
function xc(n, t) {
  const e = Ye.area(n.getPoints(32)) > 0, s = t === e ? n.curves.slice() : cm(n.curves), i = new Dn();
  return i.curves.push(...s), i;
}
function hm(n, t = 32) {
  const e = n.subPaths;
  if (!e || e.length === 0) return [];
  const s = e.map((p) => p.getPoints(t)), i = rm(s), r = am(i), a = om(i), o = e.length, c = Array(o).fill(-1), h = Array(o).fill(-1);
  for (const p of a) {
    const d = [{ idx: p, d: 0 }];
    for (; d.length; ) {
      const g = d.pop();
...
class um extends ih {
   ...
   */
  parseMeshFont(t) {
    const e = Zg(t), s = Math.round, i = e.charToGlyph("A"), r = i ? e.unitsPerEm / (i.yMax || e.unitsPerEm) : 1, a = {
      glyphs: {},
      // Lazy loaded later
  ...
  toSVG(t = {}) {
    ...
    if (i) {
      ...
      a = this.polylines.map((b) => {
        let S = "";
        return b.forEach((v, w) => {
          const F = v.x, M = -v.y;
          S += w === 0 ? `M ${F} ${M} ` : `L ${F} ${M} `;
        }), `<path d="${S}" stroke="${s}" stroke-width="${e}" fill="none"/>`;
      }).join(""), r = `${p} ${-x} ${d - p} ${x - g}`;
    } else
...
class bm {
  ...
  parseShape(t, e = {}) {
    ...
    return new os(c.currentPoint, c.polylines);
  }
  /**
  ...
  handleXYDisplacement(t, e, s) {
    let i = e;
    const r = new ft();
    return r.x = Rt.byteToSByte(t[++i]), r.y = Rt.byteToSByte(t[++i]), s.currentPoint.add(r.multiply(s.scale)), s.isPenDown && s.currentPolyline.push(s.currentPoint.clone()), i;
  }
  ...
  handleOctantArc(t, e, s) {
    var i;
    let r = e;
    const a = t[++r] * s.scale, o = Rt.byteToSByte(t[++r]), c = (o & 112) >> 4;
    let h = o & 7;
    const l = o < 0, u = Math.PI / 4 * c, f = s.currentPoint.clone().subtract(new ft(Math.cos(u) * a, Math.sin(u) * a)), p = ms.fromOctant(f, a, c, h, l);
    if (s.isPenDown) {
  ...
  handleFractionalArc(t, e, s) {
    ...
    const v = s.currentPoint.clone().subtract(new ft(h * Math.cos(b), h * Math.sin(b)));
    if (s.currentPoint = v.clone().add(new ft(h * Math.cos(S), h * Math.sin(S))), s.isPenDown) {
      let w = b;
      const F = [];
      if (F.push(
        v.clone().add(new ft(h * Math.cos(w), h * Math.sin(w)))
      ), g > 0)
        for (; w + g < S; )
          w += g, F.push(
            v.clone().add(new ft(h * Math.cos(w), h * Math.sin(w)))
      ...
      F.push(v.clone().add(new ft(h * Math.cos(S), h * Math.sin(S)))), s.currentPolyline.push(...F);
    }
    return i;
  }
  ...
  handleArcSegment(t, e, s, i, r, a) {
    ...
    if (r)
      if (s === 0)
        ...
        const c = o.clone().add(e), h = ms.fromBulge(o, c, s / 127).tessellate();
        a.push(...h.slice(1));
      }
    return o.add(e), o;
  }
...
(function(n) {
  ...
  n.Buffer = o, n.SlowBuffer = S, n.INSPECT_MAX_BYTES = 50;
  var i = 2147483647;
  ...
  function f(C, m) {
    ...
    var y = v(C, m) | 0, T = a(y), A = T.write(C, m);
    return A !== y && (T = T.slice(0, A)), T;
  }
  function p(C) {
  ...
  o.isBuffer = function(m) {
    ...
    if (m === y) return 0;
    for (var T = m.length, A = y.length, _ = 0, R = Math.min(T, A); _ < R; ++_)
      if (m[_] !== y[_]) {
        T = m[_], A = y[_];
        break;
      }
    ...
    if (y === void 0)
      for (y = 0, T = 0; T < m.length; ++T)
        y += m[T].length;
    var A = o.allocUnsafe(y), _ = 0;
    for (T = 0; T < m.length; ++T) {
      var R = m[T];
      if (Gt(R, Uint8Array))
        _ + R.length > A.length ? o.from(R).copy(A, _) : Uint8Array.prototype.set.call(
          A,
          R,
          _
        );
  ...
  o.prototype.swap16 = function() {
    ...
    for (var y = 0; y < m; y += 8)
      F(this, y, y + 7), F(this, y + 1, y + 6), F(this, y + 2, y + 5), F(this, y + 3, y + 4);
    return this;
  ...
  }, s && (o.prototype[s] = o.prototype.inspect), o.prototype.compare = function(m, y, T, A, _) {
    ...
    if (y === void 0 && (y = 0), T === void 0 && (T = m ? m.length : 0), A === void 0 && (A = 0), _ === void 0 && (_ = this.length), y < 0 || T > m.length || A < 0 || _ > this.length)
    ...
    if (y >= T)
      return 1;
    if (y >>>= 0, T >>>= 0, A >>>= 0, _ >>>= 0, this === m) return 0;
    for (var R = _ - A, Y = T - y, X = Math.min(R, Y), at = this.slice(A, _), Et = m.slice(y, T), ut = 0; ut < X; ++ut)
      if (at[ut] !== Et[ut]) {
        R = at[ut], Y = Et[ut];
        break;
      }
  ...
  function M(C, m, y, T, A) {
    if (C.length === 0) return -1;
    if (typeof y == "string" ? (T = y, y = 0) : y > 2147483647 ? y = 2147483647 : y < -2147483648 && (y = -2147483648), y = +y, At(y) && (y = A ? 0 : C.length - 1), y < 0 && (y = C.length + y), y >= C.length) {
      if (A) return -1;
      y = C.length - 1;
    } else if (y < 0)
      if (A) y = 0;
    ...
    if (typeof m == "string" && (m = o.from(m, T)), o.isBuffer(m))
      return m.length === 0 ? -1 : O(C, m, y, T, A);
    if (typeof m == "number")
      return m = m & 255, typeof Uint8Array.prototype.indexOf == "function" ? A ? Uint8Array.prototype.indexOf.call(C, m, y) : Uint8Array.prototype.lastIndexOf.call(C, m, y) : O(C, [m], y, T, A);
    throw new TypeError("val must be string, number or Buffer");
  }
  function O(C, m, y, T, A) {
    ...
    if (A) {
      var Et = -1;
      for (at = y; at < R; at++)
        if (X(C, at) === X(m, Et === -1 ? 0 : at - Et)) {
          if (Et === -1 && (Et = at), at - Et + 1 === Y) return Et * _;
        } else
          Et !== -1 && (at -= at - Et), Et = -1;
    } else
  ...
  o.prototype.write = function(m, y, T, A) {
    if (y === void 0)
      A = "utf8", T = this.length, y = 0;
    else if (T === void 0 && typeof y == "string")
      A = y, T = this.length, y = 0;
    else if (isFinite(y))
      y = y >>> 0, isFinite(T) ? (T = T >>> 0, A === void 0 && (A = "utf8")) : (A = T, T = void 0);
    else
      throw new Error(
  ...
  function U(C, m, y) {
    ...
    for (var T = [], A = m; A < y; ) {
      var _ = C[A], R = null, Y = _ > 239 ? 4 : _ > 223 ? 3 : _ > 191 ? 2 : 1;
      if (A + Y <= y) {
        var X, at, Et, ut;
        switch (Y) {
          case 1:
            ...
            break;
          case 2:
            X = C[A + 1], (X & 192) === 128 && (ut = (_ & 31) << 6 | X & 63, ut > 127 && (R = ut));
            break;
          case 3:
            X = C[A + 1], at = C[A + 2], (X & 192) === 128 && (at & 192) === 128 && (ut = (_ & 15) << 12 | (X & 63) << 6 | at & 63, ut > 2047 && (ut < 55296 || ut > 57343) && (R = ut));
            break;
          case 4:
            X = C[A + 1], at = C[A + 2], Et = C[A + 3], (X & 192) === 128 && (at & 192) === 128 && (Et & 192) === 128 && (ut = (_ & 15) << 18 | (X & 63) << 12 | (at & 63) << 6 | Et & 63, ut > 65535 && ut < 1114112 && (R = ut));
        }
      }
  ...
  o.prototype.readUintLE = o.prototype.readUIntLE = function(m, y, T) {
    ...
    for (var A = this[m], _ = 1, R = 0; ++R < y && (_ *= 256); )
      A += this[m + R] * _;
    return A;
  }, o.prototype.readUintBE = o.prototype.readUIntBE = function(m, y, T) {
    m = m >>> 0, y = y >>> 0, T || j(m, y, this.length);
    for (var A = this[m + --y], _ = 1; y > 0 && (_ *= 256); )
      A += this[m + --y] * _;
    return A;
    ...
    for (var A = this[m], _ = 1, R = 0; ++R < y && (_ *= 256); )
      A += this[m + R] * _;
    return _ *= 128, A >= _ && (A -= Math.pow(2, 8 * y)), A;
  }, o.prototype.readIntBE = function(m, y, T) {
    m = m >>> 0, y = y >>> 0, T || j(m, y, this.length);
    for (var A = y, _ = 1, R = this[m + --A]; A > 0 && (_ *= 256); )
      R += this[m + --A] * _;
  ...
  function it(C, m, y, T, A, _) {
    if (!o.isBuffer(C)) throw new TypeError('"buffer" argument must be a Buffer instance');
    if (m > A || m < _) throw new RangeError('"value" argument is out of bounds');
    if (y + T > C.length) throw new RangeError("Index out of range");
  }
  o.prototype.writeUintLE = o.prototype.writeUIntLE = function(m, y, T, A) {
    if (m = +m, y = y >>> 0, T = T >>> 0, !A) {
    ...
    for (this[y] = m & 255; ++Y < T && (R *= 256); )
      this[y + Y] = m / R & 255;
    return y + T;
  }, o.prototype.writeUintBE = o.prototype.writeUIntBE = function(m, y, T, A) {
    if (m = +m, y = y >>> 0, T = T >>> 0, !A) {
      var _ = Math.pow(2, 8 * T) - 1;
      it(this, m, y, T, _, 0);
    }
    ...
    return m = +m, y = y >>> 0, T || it(this, m, y, 1, 255, 0), this[y] = m & 255, y + 1;
  }, o.prototype.writeUint16LE = o.prototype.writeUInt16LE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 2, 65535, 0), this[y] = m & 255, this[y + 1] = m >>> 8, y + 2;
  }, o.prototype.writeUint16BE = o.prototype.writeUInt16BE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 2, 65535, 0), this[y] = m >>> 8, this[y + 1] = m & 255, y + 2;
  }, o.prototype.writeUint32LE = o.prototype.writeUInt32LE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 4, 4294967295, 0), this[y + 3] = m >>> 24, this[y + 2] = m >>> 16, this[y + 1] = m >>> 8, this[y] = m & 255, y + 4;
  }, o.prototype.writeUint32BE = o.prototype.writeUInt32BE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 4, 4294967295, 0), this[y] = m >>> 24, this[y + 1] = m >>> 16, this[y + 2] = m >>> 8, this[y + 3] = m & 255, y + 4;
  }, o.prototype.writeIntLE = function(m, y, T, A) {
    if (m = +m, y = y >>> 0, !A) {
      var _ = Math.pow(2, 8 * T - 1);
      it(this, m, y, T, _ - 1, -_);
    }
    ...
    return y + T;
  }, o.prototype.writeIntBE = function(m, y, T, A) {
    if (m = +m, y = y >>> 0, !A) {
      var _ = Math.pow(2, 8 * T - 1);
      it(this, m, y, T, _ - 1, -_);
    }
    ...
    return m = +m, y = y >>> 0, T || it(this, m, y, 1, 127, -128), m < 0 && (m = 255 + m + 1), this[y] = m & 255, y + 1;
  }, o.prototype.writeInt16LE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 2, 32767, -32768), this[y] = m & 255, this[y + 1] = m >>> 8, y + 2;
  }, o.prototype.writeInt16BE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 2, 32767, -32768), this[y] = m >>> 8, this[y + 1] = m & 255, y + 2;
  }, o.prototype.writeInt32LE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 4, 2147483647, -2147483648), this[y] = m & 255, this[y + 1] = m >>> 8, this[y + 2] = m >>> 16, this[y + 3] = m >>> 24, y + 4;
  }, o.prototype.writeInt32BE = function(m, y, T) {
    return m = +m, y = y >>> 0, T || it(this, m, y, 4, 2147483647, -2147483648), m < 0 && (m = 4294967295 + m + 1), this[y] = m >>> 24, this[y + 1] = m >>> 16, this[y + 2] = m >>> 8, this[y + 3] = m & 255, y + 4;
  };
  function yt(C, m, y, T, A, _) {
    if (y + T > C.length) throw new RangeError("Index out of range");
    if (y < 0) throw new RangeError("Index out of range");
  }
  function Ft(C, m, y, T, A) {
    return m = +m, y = y >>> 0, A || yt(C, m, y, 4), e.write(C, m, y, T, 23, 4), y + 4;
  }
  o.prototype.writeFloatLE = function(m, y, T) {
    return Ft(this, m, y, !0, T);
  ...
  o.prototype.writeDoubleLE = function(m, y, T) {
    ...
    A > this.length && (A = this.length), m.length - y < A - T && (A = m.length - y + T);
    var _ = A - T;
    return this === m && typeof Uint8Array.prototype.copyWithin == "function" ? this.copyWithin(y, T, A) : Uint8Array.prototype.set.call(
      m,
      this.subarray(T, A),
      y
    ), _;
  }, o.prototype.fill = function(m, y, T, A) {
    if (typeof m == "string") {
      if (typeof y == "string" ? (A = y, y = 0, T = this.length) : typeof T == "string" && (A = T, T = this.length), A !== void 0 && typeof A != "string")
        throw new TypeError("encoding must be a string");
      if (typeof A == "string" && !o.isEncoding(A))
        throw new TypeError("Unknown encoding: " + A);
      if (m.length === 1) {
        var _ = m.charCodeAt(0);
        (A === "utf8" && _ < 128 || A === "latin1") && (m = _);
      }
    ...
    if (typeof m == "number")
      ...
      var Y = o.isBuffer(m) ? m : o.from(m, A), X = Y.length;
      if (X === 0)
  ...
  function tt(C, m) {
    ...
    for (var y, T = C.length, A = null, _ = [], R = 0; R < T; ++R) {
      if (y = C.charCodeAt(R), y > 55295 && y < 57344) {
        ...
        if (y < 56320) {
          (m -= 3) > -1 && _.push(239, 191, 189), A = y;
          continue;
        }
        y = (A - 55296 << 10 | y - 56320) + 65536;
      } else A && (m -= 3) > -1 && _.push(239, 191, 189);
      if (A = null, y < 128) {
        if ((m -= 1) < 0) break;
        _.push(y);
      } else if (y < 2048) {
  ...
  function Ut(C, m) {
    for (var y, T, A, _ = [], R = 0; R < C.length && !((m -= 2) < 0); ++R)
      y = C.charCodeAt(R), T = y >> 8, A = y % 256, _.push(A), _.push(T);
    return _;
  }
  function Pt(C) {
  ...
  function zt(C, m, y, T) {
    for (var A = 0; A < T && !(A + y >= m.length || A >= C.length); ++A)
      m[A + y] = C[A];
    return A;
  }
  function Gt(C, m) {
  ...
  var we = function() {
    for (var C = "0123456789abcdef", m = new Array(256), y = 0; y < 16; ++y)
      for (var T = y * 16, A = 0; A < 16; ++A)
        m[T + A] = C[y] + C[A];
    return m;
  }();
})(Sa);
var hi = Sa, Pn = hi.Buffer, Jt = {}, Kt;
for (Kt in hi)
  hi.hasOwnProperty(Kt) && (Kt === "SlowBuffer" || Kt === "Buffer" || (Jt[Kt] = hi[Kt]));
var zn = Jt.Buffer = {};
for (Kt in Pn)
  Pn.hasOwnProperty(Kt) && (Kt === "allocUnsafe" || Kt === "allocUnsafeSlow" || (zn[Kt] = Pn[Kt]));
Jt.Buffer.prototype = Pn.prototype;
(!zn.from || zn.from === Uint8Array.from) && (zn.from = function(n, t, e) {
  if (typeof n == "number")
...
zn.alloc || (zn.alloc = function(n, t, e) {
  if (typeof n != "number")
...
Ta.prototype.write = function(n) {
  return this.addBOM && (n = bl + n, this.addBOM = !1), this.encoder.write(n);
};
...
Fa.prototype.write = function(n) {
  var t = this.decoder.write(n);
  return this.pass || !t || (t[0] === bl && (t = t.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), t;
};
...
function Rm() {
  ...
  function i(b) {
    ...
    switch (this.encoding) {
      case "utf16le":
        this.text = u, this.end = f, S = 4;
        break;
      case "utf8":
        this.fillLast = c, S = 4;
        break;
      case "base64":
        this.text = p, this.end = d, S = 3;
        break;
      default:
  ...
  i.prototype.write = function(b) {
    ...
    var S, v;
    if (this.lastNeed) {
      if (S = this.fillLast(b), S === void 0) return "";
      v = this.lastNeed, this.lastNeed = 0;
    } else
      v = 0;
    return v < b.length ? S ? S + this.text(b, v) : this.text(b, v) : S || "";
  ...
  function a(b, S, v) {
    ...
    if (w < v) return 0;
    var F = r(S[w]);
    return F >= 0 ? (F > 0 && (b.lastNeed = F - 1), F) : --w < v || F === -2 ? 0 : (F = r(S[w]), F >= 0 ? (F > 0 && (b.lastNeed = F - 2), F) : --w < v || F === -2 ? 0 : (F = r(S[w]), F >= 0 ? (F > 0 && (F === 2 ? F = 0 : b.lastNeed = F - 3), F) : 0));
  }
  function o(b, S, v) {
    if ((S[0] & 192) !== 128)
      return b.lastNeed = 0, "�";
    if (b.lastNeed > 1 && S.length > 1) {
      if ((S[1] & 192) !== 128)
        return b.lastNeed = 1, "�";
      if (b.lastNeed > 2 && S.length > 2 && (S[2] & 192) !== 128)
        return b.lastNeed = 2, "�";
    }
  }
  function c(b) {
    var S = this.lastTotal - this.lastNeed, v = o(this, b);
    if (v !== void 0) return v;
    if (this.lastNeed <= b.length)
      return b.copy(this.lastChar, S, 0, this.lastNeed), this.lastChar.toString(this.encoding, 0, this.lastTotal);
    b.copy(this.lastChar, S, 0, b.length), this.lastNeed -= b.length;
  }
  function h(b, S) {
    var v = a(this, b, S);
    if (!this.lastNeed) return b.toString("utf8", S);
    this.lastTotal = v;
    var w = b.length - (v - this.lastNeed);
    return b.copy(this.lastChar, 0, w), b.toString("utf8", S, w);
  }
  function l(b) {
    var S = b && b.length ? this.write(b) : "";
    return this.lastNeed ? S + "�" : S;
  }
  function u(b, S) {
    if ((b.length - S) % 2 === 0) {
      var v = b.toString("utf16le", S);
      if (v) {
        var w = v.charCodeAt(v.length - 1);
        if (w >= 55296 && w <= 56319)
          return this.lastNeed = 2, this.lastTotal = 4, this.lastChar[0] = b[b.length - 2], this.lastChar[1] = b[b.length - 1], v.slice(0, -1);
      }
      return v;
    }
    return this.lastNeed = 1, this.lastTotal = 2, this.lastChar[0] = b[b.length - 1], b.toString("utf16le", S, b.length - 1);
  }
  function f(b) {
    var S = b && b.length ? this.write(b) : "";
    if (this.lastNeed) {
      var v = this.lastTotal - this.lastNeed;
      return S + this.lastChar.toString("utf16le", 0, v);
    }
    return S;
  }
  function p(b, S) {
    var v = (b.length - S) % 3;
    return v === 0 ? b.toString("base64", S) : (this.lastNeed = 3 - v, this.lastTotal = 3, v === 1 ? this.lastChar[0] = b[b.length - 1] : (this.lastChar[0] = b[b.length - 2], this.lastChar[1] = b[b.length - 1]), b.toString("base64", S, b.length - v));
  }
  function d(b) {
    var S = b && b.length ? this.write(b) : "";
...
function Dm() {
  ...
  Me.utf32le = { type: "_utf32", isLE: !0 }, Me.utf32be = { type: "_utf32", isLE: !1 }, Me.ucs4le = "utf32le", Me.ucs4be = "utf32be", t.prototype.encoder = e, t.prototype.decoder = s;
  function e(h, l) {
    ...
    for (var l = n.from(h, "ucs2"), u = n.alloc(l.length * 2), f = this.isLE ? u.writeUInt32LE : u.writeUInt32BE, p = 0, d = 0; d < l.length; d += 2) {
      ...
      if (this.highSurrogate)
        if (x || !b)
          ...
          var S = (this.highSurrogate - 55296 << 10 | g - 56320) + 65536;
          f.call(u, S, p), p += 4, this.highSurrogate = 0;
          continue;
        }
  ...
  function c(h, l) {
    ...
    t:
      for (var b = 0; b < h.length; b++)
        for (var S = h[b], v = 0; v < S.length; v++)
          if (u.push(S[v]), u.length === 4) {
            if (f === 0) {
...
function Pm() {
  ...
  Fc = 1;
  var n = tn.Buffer;
  es.utf7 = t, es.unicode11utf7 = "utf7";
  function t(g, x) {
    this.iconv = x;
  }
  ...
  i.prototype.write = function(g) {
    for (var x = "", b = 0, S = this.inBase64, v = this.base64Accum, w = 0; w < g.length; w++)
      if (!S)
        g[w] == c && (x += this.iconv.decode(g.slice(b, w), "ascii"), b = w + 1, S = !0);
      else if (!a[g[w]]) {
        if (w == b && g[w] == h)
          x += "+";
        else {
          var F = v + this.iconv.decode(g.slice(b, w), "ascii");
          x += this.iconv.decode(n.from(F, "base64"), "utf16-be");
        }
        g[w] != h && w--, b = w + 1, S = !1, v = "";
      }
    if (!S)
  ...
  return d[44] = !0, p.prototype.write = function(g) {
    for (var x = "", b = 0, S = this.inBase64, v = this.base64Accum, w = 0; w < g.length; w++)
      if (!S)
        g[w] == l && (x += this.iconv.decode(g.slice(b, w), "ascii"), b = w + 1, S = !0);
      else if (!d[g[w]]) {
        if (w == b && g[w] == h)
          x += "&";
        else {
          var F = v + this.iconv.decode(g.slice(b, w), "ascii").replace(/,/g, "/");
          x += this.iconv.decode(n.from(F, "base64"), "utf16-be");
        }
        g[w] != h && w--, b = w + 1, S = !1, v = "";
      }
...
function Gm() {
  ...
  function c(f, p) {
    ...
    if (typeof f.gb18030 == "function") {
      ...
      this.decodeTables.push(r.slice(0));
      for (var S = this.decodeTables[0], g = 129; g <= 254; g++)
        for (var v = this.decodeTables[i - S[g]], w = 48; w <= 57; w++) {
          if (v[w] === t)
            v[w] = i - x;
          else if (v[w] > i)
  ...
  c.prototype.encoder = h, c.prototype.decoder = l, c.prototype._getDecodeTrieNode = function(f) {
      ...
      if (typeof x == "string")
        for (var b = 0; b < x.length; ) {
          ...
          if (S >= 55296 && S < 56320) {
            ...
            if (v >= 56320 && v < 57344)
              d[p++] = 65536 + (S - 55296) * 1024 + (v - 56320);
            else
    ...
    for (var S = 1; S < f.length - 1; S++) {
      var v = b[d];
      typeof v == "object" ? b = v : (b = b[d] = {}, v !== void 0 && (b[a] = v));
    }
    d = f[f.length - 1], b[d] = p;
  }, c.prototype._fillEncodeTable = function(f, p, d) {
    for (var g = this.decodeTables[f], x = !1, b = {}, S = 0; S < 256; S++) {
      var v = g[S], w = p + S;
      if (!d[w])
        if (v >= 0)
          this._setEncodeChar(v, w), x = !0;
        else if (v <= i) {
          var F = i - v;
          if (!b[F]) {
            var M = w << 8 >>> 0;
  ...
  h.prototype.write = function(f) {
    for (var p = n.alloc(f.length * (this.gb18030 ? 4 : 3)), d = this.leadSurrogate, g = this.seqObj, x = -1, b = 0, S = 0; ; ) {
      if (x === -1) {
        if (b == f.length) break;
        var v = f.charCodeAt(b++);
      } else {
        var v = x;
        x = -1;
      }
      if (v >= 55296 && v < 57344)
        if (v < 56320)
          ...
          d !== -1 ? (v = 65536 + (d - 55296) * 1024 + (v - 56320), d = -1) : v = t;
      else d !== -1 && (x = v, v = t, d = -1);
      var w = t;
      if (g !== void 0 && v != t) {
        var F = g[v];
        if (typeof F == "object") {
      ...
      w === t && (w = this.defaultCharSingleByte), w < 256 ? p[S++] = w : w < 65536 ? (p[S++] = w >> 8, p[S++] = w & 255) : w < 16777216 ? (p[S++] = w >> 16, p[S++] = w >> 8 & 255, p[S++] = w & 255) : (p[S++] = w >>> 24, p[S++] = w >>> 16 & 255, p[S++] = w >>> 8 & 255, p[S++] = w & 255);
    }
    return this.seqObj = g, this.leadSurrogate = d, p.slice(0, S);
  ...
  l.prototype.write = function(f) {
    for (var p = n.alloc(f.length * 2), d = this.nodeIdx, g = this.prevBytes, x = this.prevBytes.length, b = -this.prevBytes.length, S, v = 0, w = 0; v < f.length; v++) {
      var F = v >= 0 ? f[v] : g[v + x], S = this.decodeTables[d][F];
      if (!(S >= 0)) if (S === t)
        ...
        for (var I = this.decodeTableSeq[s - S], V = 0; V < I.length - 1; V++)
          S = I[V], p[w++] = S & 255, p[w++] = S >> 8;
        S = I[I.length - 1];
      } else
      ...
      if (S >= 65536) {
        S -= 65536;
        var D = 55296 | S >> 10;
        p[w++] = D & 255, p[w++] = D >> 8, S = 56320 | S & 1023;
      }
...
class le {
  constructor() {
    this.fontMapping = {}, this.loadedFontMap = /* @__PURE__ */ new Map(), this.unsupportedChars = {}, this.missedFonts = {}, this.enableFontCache = !0, this.defaultFonts = /* @__PURE__ */ new Set(["simkai"]), this.symbolFonts = /* @__PURE__ */ new Set(["simplex", "amgdt"]), this.events = {
  ...
  async cacheFont(t, e, s, i) {
    ...
    const h = this.buildUploadedFontAliases(
      o,
      a,
      s
    ), l = {
    ...
    try {
      const u = xe.instance.createFont(l);
      return h.forEach((f) => u.names.add(f)), this.registerFontInMap(o, u), this.enableFontCache && await We.instance.set(o, l), this.events.fontLoaded.dispatch({ fontName: o }), {
        fontName: o,
        url: "",
        status: "Success"
      };
  ...
  async loadFontFromCache(t) {
    ...
    if (this.isFontLoaded(e))
      return !0;
    const s = await We.instance.find(t);
    if (!s)
      return !1;
    try {
      const r = xe.instance.createFont(s);
  ...
  async loadFonts(t) {
    ...
    return await Promise.allSettled(e).then((i) => {
      i.forEach((r, a) => {
        const o = r.status === "fulfilled", c = t[a].url, h = Ve(c.toLowerCase());
        s.push({
          fontName: h,
          url: c,
   ...
   */
  getCodeShapeFromSymbolFonts(t, e) {
    for (const s of this.symbolFonts) {
      const i = this.loadedFontMap.get(s.toLowerCase()), r = i == null ? void 0 : i.getCodeShape(t, e);
      if (r)
        return r;
    }
  }
  ...
  async loadFont(t) {
    ...
    if (this.isFontLoaded(s.name))
      return;
    const r = await We.instance.get(i);
    if (r) {
      const a = xe.instance.createFont(r);
      this.registerFontInMap(i, a);
    } else {
      const a = await this.loader.loadAsync(t.url);
      s.data = a;
      const o = xe.instance.createFont(s);
      o && (t.name.forEach((c) => o.names.add(c)), this.registerFontInMap(i, o), this.enableFontCache && await We.instance.set(i, s));
    }
  ...
  fontInfoToFontData(t) {
    const e = Ve(t.file).toLowerCase(), s = ["ttf", "otf", "woff"].includes(t.type) ? "mesh" : t.type;
    return {
      name: e,
      alias: t.name,
      type: s,
  ...
  async getAllFontsFromCache() {
    if (this.loadedFontMap.size !== 0)
      return;
    const t = await We.instance.getAll();
    for (const e of t) {
      const { name: s } = e;
      if (this.fileNames && !this.fileNames.includes(s))
        continue;
      const i = xe.instance.createFont(e);
      this.registerFontInMap(s, i);
    }
  }
  cachedFontDataToFontInfo(t) {
    const e = `${t.name}.${t.type === "shx" ? "shx" : "ttf"}`;
    return {
      name: t.alias && t.alias.length > 0 ? [...t.alias] : [t.name],
      file: e,
      type: t.type,
      url: "",
      encoding: t.encoding,
  ...
  resolveUploadedFontType(t) {
    const e = Nu(t).toLowerCase();
    if (e === "shx")
      return "shx";
    if (["ttf", "otf", "woff"].includes(e))
      return "mesh";
  }
  buildUploadedFontAliases(t, e, s) {
    const i = /* @__PURE__ */ new Set();
    return i.add(t), i.add(Ve(e)), s == null || s.forEach((r) => {
      r && i.add(r);
    }), [...i];
  }
  /**
...
class iy {
  ...
  async load(t) {
    ...
    t.forEach((c) => {
      const h = c.toLowerCase(), l = this._avaiableFontMap.get(h);
      l && (i.set(h, l), le.instance.isFontLoaded(h) && e.push({
        fontName: h,
        url: l.url,
        status: "Success"
      }), s.push(l));
    });
    const r = await le.instance.loadFonts(s), a = {};
    [...e, ...r].forEach((c) => {
      a[c.fontName] = c;
    });
    const o = [];
    for (const c of t) {
      const h = c.toLowerCase(), l = a[h];
      if (l) {
        o.push(l);
        continue;
      }
      ...
      if (await le.instance.loadFontFromCache(c)) {
        o.push({
          fontName: h,
          url: "",
          status: "Success"
...
class ry {
  ...
  getMeshBasicMaterial(t) {
    ...
    if (!this.meshBasicMaterials[e]) {
      const s = li(t);
      this.meshBasicMaterials[e] = new Yc({
        color: s
      });
    }
  ...
  getLineBasicMaterial(t) {
    ...
    if (!this.lineBasicMaterials[e]) {
      const s = li(t);
      this.lineBasicMaterials[e] = new Zc({
        color: s
      });
    }
   ...
   */
  buildKey(t) {
    const e = t.color.aci === 256, s = li(t);
...
class ka extends ys {
   ...
   */
  getColorAsHex() {
    return this.color.isRgb && this.color.rgbValue !== null ? this.color.rgbValue : this.color.isAci && this.color.aci !== null ? oh(this.color.aci) : 16777215;
  }
  /**
...
class Pc {
  ...
  buildShapeGeometry(t, e, s, i, r, a, o, c) {
    ...
    let f = 0;
    if (u) {
      const d = u * Math.PI / 180, g = new Tt();
      g.set(
        1,
        Math.tan(d),
        0,
    ...
    if (this._currentContext.bold && p === "mesh" && h.scale(1.06, 1.06, 1), h.translate(s, i, 0), r.push(h), this._options.collectCharBoxes !== !1) {
      ...
      const d = new _t().copy(h.boundingBox);
      h instanceof hn ? o.push({
        type: ht.CHAR,
        box: d,
        char: e,
        children: []
  ...
  processText(t) {
    ...
    for (const o of t)
      ...
      } else if (o.type === nt.SPACE)
        this.processBlank(i, r);
      else if (o.type === nt.PERCENT_SYMBOL)
      ...
      else if (o.type === nt.PROPERTIES_CHANGED) {
    ...
    if (c === "^") {
      ...
      if (e.push(...O), s.push(...I), i.push(...V), r.push(...D), c === "/" || c === "#") {
        const W = new Ht(), J = new Float32Array([
          h,
          l - this.currentFontSize * 0.8 + this.defaultFontSize * ii,
          0,
          h + x,
          l - this.currentFontSize * 0.8 + this.defaultFontSize * ii,
          0
  ...
  recordStackDivider(t, e, s, i, r) {
    ...
    const a = e - this.currentFontSize * 0.8 + this.defaultFontSize * ii, o = new _t(
      new E(t, a, 0),
      new E(t + s, a, 0)
    );
  ...
  convertTopAlignedVOffset(t, e) {
    return t - e + this.defaultFontSize + this.defaultFontSize * ii;
  }
  processBlank(t, e) {
    if (this._options.collectCharBoxes !== !1) {
      const s = this._hOffset, i = this.flowDirection == oe.BOTTOM_TO_TOP ? this._vOffset : this._vOffset - this.currentLayoutFontSize, r = new _t(
        new E(s, i, 0),
        new E(
  ...
  processPercentSymbol(t, e, s, i, r) {
    if (t.kind === "literal") {
      this.processChar(t.char, e, s, i, r);
      return;
    }
    const a = this.resolvePercentSymbolShape(t);
    this.processChar(
      t.char,
      e,
      s,
  ...
  processChar(t, e, s, i, r, a) {
    const o = a ?? this.getCharShape(t);
    if (!o) {
      this.processBlank(i, r);
      return;
    }
    this._lineHasRenderableChar || this.applyPendingEmptyLineYAdjust();
    const c = o.toGeometry();
    c.scale(this.currentWidthFactor, 1, 1);
    const h = this.currentLayoutFontSize;
    let l = this._currentContext.oblique;
    this._currentContext.italic && (l += 15);
    let u = 0;
    if (l) {
      const v = l * Math.PI / 180, w = new Tt();
      w.set(
        1,
        Math.tan(v),
        0,
        ...
        0,
        1
      ), c.applyMatrix4(w), u = Math.tan(v) * h;
    }
    const f = this.fontManager.getFontType(this.currentFont);
    this._currentContext.bold && f === "mesh" && c.scale(1.06, 1.06, 1), this.hOffset > (this.maxLineWidth || 1 / 0) && (this.recordVisualLineBreak(i, r), this.advanceToNextLine(!1));
    const p = this.hOffset, d = this.flowDirection == oe.BOTTOM_TO_TOP ? this.vOffset : this.vOffset - this.currentLayoutFontSize, g = o.width * this.currentWidthFactor;
    c.translate(p, d, 0);
    const x = o.width * this.currentWidthFactor + u * this.currentWidthFactor;
    if (this.currentHorizontalAlignment == ot.DISTRIBUTED ? this._hOffset += x : this._hOffset += o.width * this.currentWordSpace * this.currentWidthFactor + u * this.currentWidthFactor, e.push(c), this._lineHasRenderableChar = !0, this._options.collectCharBoxes !== !1) {
      c.userData.char = t, c.boundingBox || c.computeBoundingBox();
      const v = new _t().copy(c.boundingBox);
      c instanceof hn ? (this._lastCharBoxTarget = "mesh", i.push({
        type: ht.CHAR,
        box: v,
        char: t,
        children: []
    ...
    const b = h * 0.05, S = 1e-3;
    if (this._currentContext.underline) {
      const v = new Ht(), w = d - b;
      v.setAttribute(
        "position",
        new he(
          new Float32Array([
      ...
      ), v.setIndex([0, 1]), v.userData = { isDecoration: !0 }, s.push(v);
    }
    if (this._currentContext.overline) {
      const v = new Ht(), w = d + h + b;
      v.setAttribute(
        "position",
        new he(
          new Float32Array([
  ...
  resolvePercentSymbolShape(t) {
    for (const e of gy(t)) {
      ...
      if (s && this.shapeHasStrokeGeometry(s, t.char))
        return this.currentFontSize > this._maxFontSize && (this._maxFontSize = this.currentFontSize), s;
    }
    return this.getCharShape(t.char);
  }
  getCharShape(t) {
    var i;
    ...
    if (s && !e && (e = this.fontManager.getCharShape(
      t,
      s,
      this.currentFontSize
      ...
      r != null && (e = this.fontManager.getCodeShapeFromSymbolFonts(
        r,
        this.currentFontSize
      ));
    }
    return (!e || !this.shapeHasStrokeGeometry(e, t)) && (e = this.fontManager.getNotFoundTextShape(this.currentFontSize)), this.currentFontSize > this._maxFontSize && (this._maxFontSize = this.currentFontSize), e;
  }
  ...
  toThreeObject(t, e, s, i, r) {
    const a = new co(), o = this.getMaterialColorSettings(), c = this.styleManager.getMeshBasicMaterial(
      ...
      o
    ), l = this._options.collectCharBoxes !== !1, u = t.filter((p) => p instanceof hn);
    if (u.length > 0) {
      const p = u.length > 1 ? dc(u) : u[0], d = new cs(p, c);
      d.userData.bboxIntersectionCheck = !0, d.userData.charBoxType = r, l && s.length > 0 && (d.userData.layout = { chars: s.slice() }), a.add(d);
    }
    const f = [
      ...e,
      ...t.filter((p) => !(p instanceof hn))
    ];
    if (f.length > 0) {
      const p = this.mergeLineGeometries(f), d = new Jc(p, h);
...
const ns = /* @__PURE__ */ new E(), Oe = /* @__PURE__ */ new E(), _e = /* @__PURE__ */ new E(), zc = /* @__PURE__ */ new E(1, 0, 0);
class Aa extends jt {
  /**
  ...
  constructor(t, e, s, i, r = ay()) {
    super(), this._style = e, this._styleManager = s, this._fontManager = i, this._colorSettings = {
      ...
      layer: r.layer,
      color: r.color.copy()
    }, this._box = new _t(), this._layoutData = void 0, this._mtextData = t, this._fontsInStyleLoaded = !1;
  }
  /**
   ...
   */
  async asyncDraw() {
    const t = Array.from(Aa.getFonts(this._mtextData.text || "", !0));
  ...
  raycast(t, e) {
    this.createLayoutData().chars.forEach((i) => {
      if (i.box && t.ray.intersectBox(i.box, ns)) {
        const r = t.ray.origin.distanceTo(ns);
        e.push({
          distance: r,
          point: ns.clone(),
          object: this,
  ...
  measureAnchorMetrics(t, e, s, i, r) {
    ...
    t.traverse((g) => {
      ...
      !x || x.length === 0 || x.forEach((S) => {
        const v = S.y - S.height / 2, w = S.y + S.height / 2;
        a.hasLine = !0, a.minY = Math.min(a.minY, v), a.maxY = Math.max(a.maxY, w), o || (a.baselineY = v, o = !0);
      });
    });
  ...
  getLayout(t, e, s) {
    ...
    if (r && r.length > 0 && r.forEach((f) => {
      ns.set(0, f.y, 0).applyMatrix4(t.matrixWorld), Oe.set(0, f.y - f.height / 2, 0).applyMatrix4(t.matrixWorld), _e.set(0, f.y + f.height / 2, 0).applyMatrix4(t.matrixWorld), s.push({
        y: ns.y,
        height: Math.abs(_e.y - Oe.y),
  ...
  updateBoxFromObject(t, e) {
    ...
    i && i.length > 0 && i.forEach((p) => {
      Oe.set(0, p.y - p.height / 2, 0).applyMatrix4(t.matrixWorld), _e.set(0, p.y + p.height / 2, 0).applyMatrix4(t.matrixWorld), e.hasLine = !0, e.minX = Math.min(e.minX, Oe.x, _e.x), e.maxX = Math.max(e.maxX, Oe.x, _e.x), e.minY = Math.min(e.minY, Oe.y, _e.y), e.maxY = Math.max(e.maxY, Oe.y, _e.y), e.minZ = Math.min(e.minZ, Oe.z, _e.z), e.maxZ = Math.max(e.maxZ, Oe.z, _e.z);
    });
    ...
    if (t instanceof Pr || t instanceof cs) {
      ...
      if (!((f = p.userData) != null && f.isDecoration)) {
        ...
        const d = new _t().copy(p.boundingBox);
  ...
  try {
    switch (t) {
      ...
      case "loadFonts": {
        ...
        const { fonts: i } = s;
        await an.loadFontsByNames(i), self.postMessage({
          type: "loadFonts",
          id: e,
          success: !0,
          data: { loaded: i }
      ...
      case "setDefaultFonts": {
        ...
        an.setDefaultFonts(i), an.setSymbolFonts(r), self.postMessage({
          type: "setDefaultFonts",
          id: e,
          success: !0,
          data: {
            fonts: [...an.defaultFonts],
            symbolFonts: [...an.symbolFonts]
          }
        });
        break;
      }
...
function Cy(n) {
  ...
  return n.updateWorldMatrix(!0, !0), Nc.copy(n.matrixWorld).invert(), n.traverse((s) => {
    var i, r, a, o;
    if (s instanceof cs || s instanceof Jc) {
      const c = s.geometry, h = s.material;
      if (c instanceof Ht) {
        const l = new E(), u = new gn(), f = new E();
        Hc.multiplyMatrices(
          Nc,
          s.matrixWorld
        ), Hc.decompose(l, u, f);
        const p = {};
        c.attributes && Object.keys(c.attributes).forEach((b) => {
          const S = c.attributes[b], F = new Uint8Array(
            S.array.buffer,
            S.array.byteOffset,
            S.array.byteLength
          ).slice().buffer;
        ...
        let d = null;
        if (c.index) {
          const b = c.index.array, w = new Uint8Array(
            b.buffer,
            b.byteOffset,
            b.byteLength
          ).slice().buffer;
          e.push(w), d = {
            ...
            byteOffset: 0,
            length: b.length,
            componentType: b instanceof Uint32Array ? "uint32" : "uint16"
          };
        }
        const g = {
          type: h.type,
        ...
        "side" in h && typeof h.side == "number" && (g.side = h.side), "linewidth" in h && typeof h.linewidth == "number" && (g.linewidth = h.linewidth);
        const x = {
          type: s instanceof cs ? "mesh" : "line",
          position: {
            x: l.x,
            y: l.y,
            z: l.z
